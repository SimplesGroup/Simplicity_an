 ...
 */
public class Farmingdescription extends AppCompatActivity {
    ...
    private String URL="http://simpli-city.in/request2.php?rtype=farming&key=simples&fid=";
    String URLTWO;
     String name ;
     String titl;
    ...
    String searchactivity_farming,searchnonitiid;
    ...
    String URLCOMMENT = "http://simpli-city.in/request2.php?rtype=viewcomment&key=simples&qtype=farming&id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("farmingdesc")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
       ...
       // recycler_comment.addItemDecoration(new DividerItemDecoration(getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*if(searchactivity_farming.equalsIgnoreCase("farmingsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), FarmingSeachview.class);
                    ...
                    Intent backfarming = new Intent(Farmingdescription.this, MainActivityVersiontwo.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufarming = new Intent(Farmingdescription.this, MainPageEnglish.class);
                startActivity(menufarming);
                finish();
            }
        });
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "farmingdesc");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin = new Intent(Farmingdescription.this, SigninpageActivity.class);
                    startActivity(signin);
                    finish();
                }
            }
    ...
    private void parseJsonFeed(JSONArray response) {
        ImageLoader  mImageLoader = simplicity_an.simplicity_an.MySingleton.getInstance(Farmingdescription.this).getImageLoader();
        try {
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View root = inflater.inflate(R.layout.commentfarmingfragment, container, false);
