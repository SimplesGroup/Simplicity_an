 ...
 private static    List<ItemModel> modelLists = new ArrayList<ItemModel>();
   ...
   /* public void onStop() {
    ...
    public void onAttach(android.app.Activity activity) {
        ...
        try {
            mlListener = (OnFragmentInteractionListener) activity;
    ...
    class Recyclerviewtaballadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (holder instanceof Userviewholdertaball) {
               ...
               if(likecount.equals("0")){                      userViewHolder.like_imagebutton.setImageResource(R.mipmap.heartfullred);                     userViewHolder.like_imagebutton.setTag("heartfullred");                    /* userViewHolder.likes_button.setText("Like");                      userViewHolder.likes_button.setCompoundDrawablesRelativeWithIntrinsicBounds(R.mipmap.like,0,0,0);                     userViewHolder.likes_button.setTextColor(getResources().getColor(R.color.white));                     userViewHolder.likes_button.setTypeface(seguiregular);*/                   }else {                     userViewHolder.like_imagebutton.setImageResource(R.mipmap.heart);                     userViewHolder.like_imagebutton.setTag("heart");                     /*userViewHolder.likes_button.setTextColor(getActivity().getResources().getColor(R.color.red));                     userViewHolder.likes_button.setText("Liked");                     userViewHolder.likes_button.setCompoundDrawablesRelativeWithIntrinsicBounds(R.mipmap.likered,0,0,0);                     userViewHolder.likes_button.setTypeface(seguiregular);*/                  }
