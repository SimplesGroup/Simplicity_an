 ...
 */
public class TabEducation extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldata&key=simples&qtype=education";
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof Userviewholdertaball) {
                ...
                if(itemmodel.getLikescount()==0){
                    ...
                    userViewHolder.likescount.setText(itemmodel.getLikescount()+"Likes");
                ...
                if(itemmodel.getCommentscount()==0){
                    ...
                    userViewHolder.commentscount.setTypeface(seguiregular);
                    userViewHolder.commentscount.setText(itemmodel.getCommentscount()+"Comments");
                    userViewHolder.countlayout.setVisibility(View.VISIBLE);
                }
