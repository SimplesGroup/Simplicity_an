 ...
 */
public class TabEducation extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=education";
...
private static     Recyclerviewtaballadapter recyclerview_tab_all_adapteredu;
 private static    List<ItemModel> modelListsedu=new ArrayList<ItemModel>();
    private boolean isFragmentLoaded=false;
FloatingActionButton fabeducation,fabplus;
...
int like_finalvalues;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabeducation.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 ...
                 modelListsedu.clear();
                 recyclerview_tab_all_adapteredu.notifyDataSetChanged();
                 requestCount=0;
                 getData();
       ...
       // getData();
        recyclerview_tab_all_adapteredu = new Recyclerviewtaballadapter(modelListsedu, recyclerview_tab_all);
        recyclerview_tab_all.setAdapter(recyclerview_tab_all_adapteredu);
        recyclerview_tab_all_adapteredu.setOnLoadMoreListener(new OnLoadMoreListener() {
            @Override
            public void onLoadMore() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        recyclerview_tab_all_adapteredu.setLoaded();
                    }
                }, 2000);
            }
        });
    ...
    @Override
    public void change() {
        Log.e("SIZE",modelListsedu.toString());
        recyclerview_tab_all_adapteredu.Font(modelListsedu);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabeducation.setVisibility(View.VISIBLE);
                                }else {
                                    fabeducation.setVisibility(View.GONE);
                                }
                                if (!loading
