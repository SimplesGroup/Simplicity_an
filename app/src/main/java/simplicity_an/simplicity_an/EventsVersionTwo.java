...
public class EventsVersionTwo extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
 ...
 HealthViewPagerAdapter mAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eventsversiontwo);
...
*/
        ...
        explore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent entairnment=new Intent(getApplicationContext(),EntertainmentVersiontwo.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent old_main=new Intent(getApplicationContext(),MainActivity.class);
    ...
    private void setupViewPager(ViewPager mPager) {
       HealthViewPagerAdapter adapter = new HealthViewPagerAdapter(getSupportFragmentManager());
        adapter.addFragment(new Tabevent(), "All Events");
        adapter.addFragment(new Tabeventtoday(), "Today");
        adapter.addFragment(new Tabeventtomorrow(), "Tomorrow");
        adapter.addFragment(new TabeventPooja(), "Poojai");
