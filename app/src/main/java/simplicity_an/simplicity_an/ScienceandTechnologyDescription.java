 ...
 */
public class ScienceandTechnologyDescription extends AppCompatActivity {
...
requestQueue=Volley.newRequestQueue(this);
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("sciencedesc")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* if(searchactivity_science.equalsIgnoreCase("Sciencesearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), ScienceSearchview.class);
                    ...
                    Intent backsciencedesc = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
...
onBackPressed();
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menusciencedesc = new Intent(getApplicationContext(), MainPageEnglish.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "sciencedesc");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin = new Intent(ScienceandTechnologyDescription.this, SigninpageActivity.class);
