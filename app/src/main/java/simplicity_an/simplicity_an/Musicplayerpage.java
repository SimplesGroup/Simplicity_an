 ...
 */
public class Musicplayerpage extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    ...
    private String URL="http://simpli-city.in/request2.php?rtype=music&key=simples";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //catid=gets.getStringExtra("ID");
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("music")){
                catid=contentid;
       ...
       /* Intent get=getIntent();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayers.stop();
               /* Intent backmusicplayer=new Intent(getApplicationContext(),MusicActivity.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "music");
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent signin=new Intent(Musicplayerpage.this,SigninpageActivity.class);
        ...
        favbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent in=new Intent(Musicplayerpage.this,SigninpageActivity.class);
                    startActivity(in);
                }
            }
        });
