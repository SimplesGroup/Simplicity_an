 ...
 */
public class RadioJockeyDetailpage extends AppCompatActivity {
    ...
    String URL="http://simpli-city.in/request2.php?rtype=radio&key=simples&rj_id=";
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.radiojockeydetail);
        ...
        imageLoader= CustomVolleyRequest.getInstance(RadioJockeyDetailpage.this).getImageLoader();
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back=new Intent(RadioJockeyDetailpage.this,MainActivityVersiontwo.class);
                startActivity(back);
                finish();
            }
        });
        ...
        musicall.addOnItemTouchListener(new MusicActivity.RecyclerTouchListener(this, musicall, new MusicActivity.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent i = new Intent(RadioJockeyDetailpage.this, Radiojockeyplayer.class);
                i.putExtra("ID", getid);
               // i.putExtra("FID", fid);
