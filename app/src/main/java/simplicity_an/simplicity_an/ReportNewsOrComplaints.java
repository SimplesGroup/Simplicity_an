 ...
 */
public class ReportNewsOrComplaints extends AppCompatActivity {
...
mImageLoader= MySingleton.getInstance(getApplicationContext()).getImageLoader();
        ...
        camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ContextCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED){
                    ActivityCompat.requestPermissions(ReportNewsOrComplaints.this,new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE, android.Manifest.permission.CAMERA},0);
                }
            }
        });
    ...
    private void showFileChooser() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ReportNewsOrComplaints.this);
