 ...
 */
public class FoodCategoryPage extends AppCompatActivity {
    ...
    RecyclerViewAdapter rcAdapter;
     ...
     String URLTW="http://simpli-city.in/request.php?rtype=foodcategory&key=simples";
    String URLTHREE;
     String URLFOUR;
    String id_food;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spin=(Spinner)findViewById(R.id.my_spinnerfood);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent backfoodcat=new Intent(getApplicationContext(),FoodActivity.class);
                startActivity(backfoodcat);
                finish();*/
                onBackPressed();
            }
        });
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufoodcat=new Intent(getApplicationContext(), MainPageEnglish.class);
                startActivity(menufoodcat);
                finish();
            }
        });
        Intent in=getIntent();
        ...
        rView = (RecyclerView) findViewById(R.id.pick_itemfood);
        ...
        rView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), rView, new ClickListener() {
            public void onClick(View view, int position) {
                String bitmap = ((ItemModel) modelList.get(position)).getId();

                Intent fooddescription = new Intent(getApplicationContext(), FoodAndCookDescriptionPage.class);
                fooddescription.putExtra("ID", bitmap);
        ...
        spin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    URLFOUR = "http://www.simples.in/scty/request2.php?rtype=foodnew&key=simples&fid=" + id_food;
                    modelList.clear();
                    jsontwo();
                }
            }
        ...
        URLTHREE="http://simpli-city.in/request2.php?rtype=foodnew&key=simples&fid="+id;
        json();
        pdialog.show();
        ...
        simplicity_an.simplicity_an.MySingleton.getInstance(this).addToRequestQueue(arrayReq);
