 ...
 */
public class TabBeyondNational extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=othernews&key=simples&qtype=national";
...
FloatingActionButton fabbeyondnational;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabbeyondnational=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        fabbeyondnational.setOnClickListener(new View.OnClickListener() {
            @Override
