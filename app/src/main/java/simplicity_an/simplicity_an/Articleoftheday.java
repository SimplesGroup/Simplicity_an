 ...
 */
public class Articleoftheday extends AppCompatActivity {
   List<ItemModel> modelList=new ArrayList<ItemModel>();
    String URL="http://simpli-city.in/request2.php?rtype=article&key=simples";
      ...
      mCollapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout);*/
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent searchintent=new Intent(Articleoftheday.this,Articlesearchview.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menu=new Intent(Articleoftheday.this, MainPageEnglish.class);
                startActivity(menu);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* try {
                    Intent back = new Intent(Articleoftheday.this, MainActivityVersiontwo.class);
                    startActivity(back);
                    finish();
                } catch (Exception e) {
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(Articleoftheday.this, MainPageEnglish.class);
        ...
        Toolbartitle.setText("Article of the Day");
            ...
            if(holder instanceof ViewitemTwoholder){
                ...
                if(itemmodel.getTypeid()==1) {
                    if (mImageLoader == null)
                        ...
                        mImageLoader = CustomVolleyRequest.getInstance(Articleoftheday.this).getImageLoader();
