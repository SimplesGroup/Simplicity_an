 ...
 */
public class Tabgovt extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=govt";
...
FloatingActionButton fabgovt,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
   private static Recyclerviewtaballadapter recyclerview_tab_all_adapter;
    private static List<ItemModel> modelListsgovt=new ArrayList<ItemModel>();
...
OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabgovt.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsgovt.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                  ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
      ...
      //  getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsgovt,recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsgovt);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabgovt.setVisibility(View.VISIBLE);
                                }else {
                                    fabgovt.setVisibility(View.GONE);
                                }
                                if (!loading
