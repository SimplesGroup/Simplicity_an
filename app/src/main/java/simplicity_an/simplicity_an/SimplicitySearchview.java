 ...
 */
public class SimplicitySearchview extends AppCompatActivity {
     ...
     /*   url_notification_count_valueget=url_noti_count+myprofileid;*/
      ...
      //  mCollapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar_layout);
        ...
        city_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent citysearch=new Intent(SimplicitySearchview.this,MainPageEnglish.class);
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (holder instanceof UserViewHolder) {
               ...
               ItemModel itemModel=modelListsearch.get(position);
