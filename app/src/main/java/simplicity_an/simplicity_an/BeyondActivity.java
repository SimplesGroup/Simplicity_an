 ...
 */
public class BeyondActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beyondversiontwo);
        ...
        language_title.setText("| தமிழ்");
        language_title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent tamil=new Intent(getApplicationContext(),MainActivityTamil.class);
                startActivity(tamil);
                finish();
            }
        });
        ...
        title_coimbatore.setText("Beyond Coimbatore");
        ...
        explore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent entairnment=new Intent(BeyondActivity.this, EntertainmentVersiontwo.class);
        ...
        beyond.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beyond=new Intent(BeyondActivity.this,BeyondActivity.class);
        ...
        city.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beyond=new Intent(BeyondActivity.this, MainActivityVersiontwo.class);
                startActivity(beyond);
                finish();
            }
        });
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent old_main=new Intent(BeyondActivity.this,MainActivity.class);
        ...
        notifications.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    if (value == 0) {
                        Intent notification_page = new Intent(BeyondActivity.this, NotificationSettingsactivity.class);
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "beyondversion");
                    editor.putString(CONTENTID, "0");
                    editor.commit();
                    Intent signin=new Intent(BeyondActivity.this,SigninpageActivity.class);
    ...
    private void setupViewPager(ViewPager mPager) {
        ...
        adapter.addFragment(new TabBeyondAll(), "All");
        adapter.addFragment(new TabBeyondNational(), "National");
        adapter.addFragment(new TabBeyondInternationl(), "International");
