 ...
 */
public class Healthylivingdescription extends AppCompatActivity {
    TextView tv,health,authorname,pdate,sourcelinknews,sourcelinksimplicity;//description;
    NetworkImageView thump;
    WebView description;
    ImageButton comment,share,menu,back,favourite;
    String titl;
   List<ItemModel> modelList=new ArrayList<ItemModel>();
     String URL="http://simpli-city.in/request2.php?rtype=healthliving&key=simples&id=";
    String URLTWO;
    ...
    String URLCOMMENT = "http://simpli-city.in/request2.php?rtype=viewcomment&key=simples&qtype=health&id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.healthylivingdescription);
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("healthdesc")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
      ...
      //  recycler_comment.addItemDecoration(new DividerItemDecoration(getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        health=(TextView)findViewById(R.id.text_helathandliving);
        health.setPadding(7, 25, 7, 4);
        // authorname.setPadding(7,7,7,7);
        ...
        Typeface tf1 = Typeface.createFromAsset(getApplicationContext().getAssets(), simplycity_title_fontPathone);
...
/*
                if(searchactivity_health.equalsIgnoreCase("healthsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), HealthSearchview.class);
                    ...
                    Intent backhealthdesc = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
                    startActivity(backhealthdesc);
                    finish();
                }*/
                onBackPressed();
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menuhealthdesc = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
                startActivity(menuhealthdesc);
                finish();
            }
        });
        if(myprofileid!=null){
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "healthdesc");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin=new Intent(Healthylivingdescription.this,SigninpageActivity.class);
