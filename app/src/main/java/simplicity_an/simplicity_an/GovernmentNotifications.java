 ...
 */
public class GovernmentNotifications extends AppCompatActivity {
     List<ItemModel> modelList=new ArrayList<ItemModel>();
    String URL="http://simpli-city.in/request2.php?rtype=govtnotification&key=simples&page=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent search_intent=new Intent(GovernmentNotifications.this,Govtsearchview.class);
     ...
     menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menu=new Intent(GovernmentNotifications.this, MainPageEnglish.class);
                startActivity(menu);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                try {
//                    Intent back = new Intent(GovernmentNotifications.this, MainActivityVersiontwo.class);
//                    startActivity(back);
//                    finish();
//                }catch (Exception e){
//
//                }
        ...
        Toolbartitle.setText("Government Notification");
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(GovernmentNotifications.this, MainPageEnglish.class);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof ViewitemTwoholder){
                if(mImageLoader==null)
                    mImageLoader = CustomVolleyRequest.getInstance(GovernmentNotifications.this).getImageLoader();
