 ...
 */
public class DoitSearchview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.doitsearchview);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(DoitSearchview.this, MainPageEnglish.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menudoit = new Intent(DoitSearchview.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backdoit = new Intent(DoitSearchview.this, DoitYourself.class);
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_doit);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_doit);
        Toolbartitle.setText("Do it Yourself");
        recycler = (RecyclerView)findViewById(R.id.searchview_doit_recyclerview);
    ...
    private void Search(){
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=do_it_yourself&q="+search_value;
