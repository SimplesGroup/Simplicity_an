 ...
 */
public class TabScience extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=science";
...
FloatingActionButton fabscience,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
    private static Recyclerviewtaballadapter recyclerview_tab_all_adapter;
    private static List<ItemModel> modelListsscience=new ArrayList<ItemModel>();
...
OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabscience.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
      ...
      //  getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsscience, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsscience);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabscience.setVisibility(View.VISIBLE);
                                }else {
                                    fabscience.setVisibility(View.GONE);
                                }
                                if (!loading
