    ...
    requestQueue=Volley.newRequestQueue(this);
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("tipsdesc")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "tipsdesc");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin = new Intent(TipsDescription.this, SigninpageActivity.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menutips = new Intent(TipsDescription.this, MainActivityVersiontwo.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backtips = new Intent(TipsDescription.this, MainActivityVersiontwo.class);
