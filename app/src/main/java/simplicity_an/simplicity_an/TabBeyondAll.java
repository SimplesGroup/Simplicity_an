...
FloatingActionButton fabbeyondall;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabbeyondall=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        fabbeyondall.setOnClickListener(new View.OnClickListener() {
            @Override
