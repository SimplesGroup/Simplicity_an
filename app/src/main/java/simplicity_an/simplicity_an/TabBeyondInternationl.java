 ...
 */
public class TabBeyondInternationl extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=othernews&key=simples&qtype=international";
...
FloatingActionButton fabbeyondinternational;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabbeyondinternational=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        fabbeyondinternational.setOnClickListener(new View.OnClickListener() {
            @Override
