...
public class TabEntertainmentTheatre extends Fragment {
    ...
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldata&key=simples&qtype=theatre";
    ...
    private void parseJsonFeed(JSONObject response){
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                model.setYoutubelink(obj.getString("youtube"));
    ...
    class Recyclerviewtaballadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof Userviewholdertaball) {
                ...
                if(itemmodel.getQtypemain().equalsIgnoreCase("theatre")||itemmodel.getQtype().equals("Independent Movies")){
                        ...
                        switch (view.getId()) {
                            case R.id.listlayout_taball:
                                ...
                                if(itemmodel.getQtype().equals("Sponsered")||itemmodel.getQtype().equals("Sponsored")){
                                    ...
                                    startActivity(intent);
                                    /*Intent intent = new Intent(getActivity(), TheatreItemDetail.class);
                                    intent.putExtra("ID", ids);
                                    startActivity(intent);*/
                                }
