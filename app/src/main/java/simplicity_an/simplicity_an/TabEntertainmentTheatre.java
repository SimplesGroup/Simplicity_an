 ...
 */
public class TabEntertainmentTheatre extends Fragment implements ChangeFont {
...
FloatingActionButton fabentertainmenttheatre,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
  private static   Recyclerviewtaballadapter recyclerview_tab_all_adapter;
  private static   List<ItemModel> modelListstheatre=new ArrayList<ItemModel>();
...
private OnFragmentInteractionListener mListener;
    ...
    public TabEntertainmentTheatre() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabentertainmenttheatre=(FloatingActionButton)view.findViewById(R.id.fabButton) ;

        if(colorcodes.equals("#FFFFFFFF")){
            fabentertainmenttheatre.setImageResource(R.mipmap.uptamil);
        }
        else{
            fabentertainmenttheatre.setImageResource(R.mipmap.uparrow);
        }
        fabentertainmenttheatre.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabentertainmenttheatre.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListstheatre.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                 ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
       ...
       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListstheatre, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListstheatre);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabentertainmenttheatre.setVisibility(View.VISIBLE);
                                }else {
                                    fabentertainmenttheatre.setVisibility(View.GONE);
                                }
                                if (!loading
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (holder instanceof Userviewholdertaball) {
                ...
                mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
                 String playfair ="fonts/Lora-Regular.ttf";
