 ...
 */
public class Columnsdetailpage extends AppCompatActivity {
...
int favcount;
    ...
    List<ItemModel> modelList=new ArrayList<ItemModel>();
     String URL="http://simpli-city.in/request2.php?rtype=columns&key=simples&id=";
    String URLTWO;
    ...
    String URLCOMMENT = "http://simpli-city.in/request2.php?rtype=viewcomment&key=simples&qtype=columns&id=";
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    editor.commit();
                    Intent signin=new Intent(Columnsdetailpage.this,SigninpageActivity.class);
