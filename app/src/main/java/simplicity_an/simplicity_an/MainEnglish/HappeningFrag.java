...
public class HappeningFrag extends Fragment {
  ...
  Typeface tf_play,tf;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        notificationto_visible_currenttab=get.getStringExtra("DETAIL");
       ...
       /*beyond.setOnClickListener(new View.OnClickListener() {
        ...
        font_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(fontname.equals("playfair")){
                    ...
                    ChangeFont font=new Tabevent();
                    font.change();

                    font=new Tabeventtoday();
                    font.change();
                   /* font=new Tabeventtomorrow();
                    font.change();*/
        ...
        if(notificationto_visible_currenttab==null||notificationto_visible_currenttab==""){

        }else {
            mPager.setCurrentItem(2);
        }
        if(tab_id!=null){
            mPager.setCurrentItem(Integer.parseInt(tab_id));
        }
...
setupTabIcons();
    ...
    private void setupViewPager(ViewPager mPager) {
       ...
       // adapter.addFragment(new TabeventPooja(), "Religious");
