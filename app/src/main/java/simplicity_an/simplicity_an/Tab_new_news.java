   ...
   //model.setShortdescription(obj.getString("short_description"));
    ...
    model.setAlbum(album);
                ...
                try {
                    ...
                    if (subtitle.equals("Today's Events in Coimbatore")) {
     ...
     private final int VIEW_TYPE_PHOTOSTORY_NEW = 7;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof Userviewholdertaball) {
                ...
                Horizontaladapter horizontaladapter=new Horizontaladapter(videolist,horizontalviewholder.horizontal_recylerview,getActivity());
