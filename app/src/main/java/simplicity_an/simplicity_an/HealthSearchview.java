 ...
 */
public class HealthSearchview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(HealthSearchview.this, MainPageEnglish.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menuhealthsearch = new Intent(getApplicationContext(), MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*Intent backhealthsearch = new Intent(getApplicationContext(),HealthAndLiving.class);
