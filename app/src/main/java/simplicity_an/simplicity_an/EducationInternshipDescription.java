 ...
 */
public class EducationInternshipDescription extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent backjobdetail=new Intent(getApplicationContext(),MainActivityVersiontwo.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menujobdeatail=new Intent(getApplicationContext(), MainPageEnglish.class);
    ...
    private void setupViewPager(ViewPager mPager) {
        ...
        adapter.addFragment(new FragmentEducationJobDescription(), "Job Description");
        adapter.addFragment(new FragmentEducationEmployerinfo(), "Employee Info");
