 ...
 */
public class SportsnewsDescription extends AppCompatActivity {
...
String searchnonitiid,searchactivity_sports;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      supportRequestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(R.layout.sportsnewsdescription);
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("sportsdesc")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
      ...
      title=(TextView)findViewById(R.id.textView_titlename_sports);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  if(searchactivity_sports.equalsIgnoreCase("sportssearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), Sportssearchview.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent memusportsdesc = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
     ...
     comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "sportsdesc");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin=new Intent(SportsnewsDescription.this,SigninpageActivity.class);
