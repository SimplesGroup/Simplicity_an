 ...
 */
public class MusicnewReleaseplayer extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    ...
    private String URL="http://simpli-city.in/request2.php?rtype=music-release&key=simples&fid=";
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    editor.commit();
                    Intent signin=new Intent(MusicnewReleaseplayer.this,SigninpageActivity.class);
