 ...
 */
public class TabHealth extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=health";
...
FloatingActionButton fabhealth,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
    private static Recyclerviewtaballadapter recyclerview_tab_all_adapter;
    private static List<ItemModel> modelListshealth=new ArrayList<ItemModel>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabhealth=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        if(colorcodes.equals("#FFFFFFFF")){
            fabhealth.setImageResource(R.mipmap.uptamil);
        }
        else{
            fabhealth.setImageResource(R.mipmap.uparrow);
        }
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabhealth.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListshealth.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                 ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
       ...
       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListshealth, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListshealth);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabhealth.setVisibility(View.VISIBLE);
                                }else {
                                    fabhealth.setVisibility(View.GONE);
                                }
                                if (!loading
