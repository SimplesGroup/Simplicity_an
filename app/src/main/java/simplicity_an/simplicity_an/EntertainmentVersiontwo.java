 ...
 */
public class EntertainmentVersiontwo extends AppCompatActivity implements TabEntertainmentAll.OnFragmentInteractionListener,TabEntertainmentMusic.OnFragmentInteractionListener,TabentertainmentRadio.OnFragmentInteractionListener{
...
FloatingActionButton fabsearch,fabinnerplus,fabplus,fabup;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.entertainmentversiontwo);
      ...
      /*  notification_batge_count=(TextView)findViewById(R.id.text_batchvalue_main);
       ...
       /* if(myprofileid!=null) {
        ...
        language_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent tamil=new Intent(getApplicationContext(),MainPageTamil.class);
                startActivity(tamil);
                finish();
       ...
       /* explore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent entairnment=new Intent(EntertainmentVersiontwo.this,EntertainmentVersiontwo.class);
        ...
        beyond.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beyond=new Intent(EntertainmentVersiontwo.this,EventsVersionTwo.class);
        ...
        city.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent beyond = new Intent(EntertainmentVersiontwo.this, MainPageEnglish.class);
                startActivity(beyond);
                overridePendingTransition(R.anim.lefttoright, R.anim.lefttoright);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent old_main=new Intent(EntertainmentVersiontwo.this,MainActivity.class);
        ...
        notifications.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        Intent notification_page = new Intent(EntertainmentVersiontwo.this, MainPageEnglish.class);
    ...
    private void setupViewPager(ViewPager mPager) {
        ...
        adapter.addFragment(new TabEntertainmentTheatre(), "Movies");
