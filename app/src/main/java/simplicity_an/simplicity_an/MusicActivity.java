...
music_newreleases.addOnItemTouchListener(new MusicActivity.RecyclerTouchListener(this,music_newreleases,new MusicActivity.ClickListener(){
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolders> {
        ...
        public void onBindViewHolder(RecyclerViewHolders holder, int position) {
            ...
            mImageLoader = simplicity_an.simplicity_an.MySingleton.getInstance(MusicActivity.this).getImageLoader();
