...
public class AdvertisementPageweb extends AppCompatActivity {
   ...
   /* pdate = (TextView) findViewById(R.id.authordate);
     ...
     /*articleoftheday.setTypeface(tf_regular);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menu_article = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
        ...
        class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                if (viewType == VIEW_TYPE_ITEM) {
                    ...
                    return new MyDialogFragment.UserViewHolder(view);
                } else if (viewType == VIEW_TYPE_LOADING) {
                    View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_loading_item, parent, false);
                    return new MyDialogFragment.LoadingViewHolder(view);
                }
                return null;
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                } else if (holder instanceof MyDialogFragment.LoadingViewHolder) {
                    MyDialogFragment.LoadingViewHolder loadingViewHolder = (MyDialogFragment.LoadingViewHolder) holder;
                    loadingViewHolder.progressBar.setIndeterminate(true);
                }
