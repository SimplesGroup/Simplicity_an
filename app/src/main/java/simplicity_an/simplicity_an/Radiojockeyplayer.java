 ...
 */
public class Radiojockeyplayer extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    ...
    String catid,URLTWO,URLTHREE,fidvalue,gettitle,getdate,getimage;
    private List<ItemModel> modelList=new ArrayList<ItemModel>();
    private List<ItemModel> modelListtwo=new ArrayList<ItemModel>();

    private String URL="http://simpli-city.in/request2.php?rtype=radio&key=simples&rj_id=";
    private String URLS="http://simpli-city.in/request2.php?rtype=music&key=simples";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.radiojockeyplayerpage);
        ...
        //fidvalue=gets.getStringExtra("FID");

        gettitle=gets.getStringExtra("TITLE");
        getdate=gets.getStringExtra("DATE");
        getimage=gets.getStringExtra("IMAGE");
        if(activity==null){
            Intent getnotifi=getIntent();
            catid=getnotifi.getStringExtra("ID");

            catid = catid.replaceAll("\\D+","");
          //  fidvalue=getnotifi.getStringExtra("FID");
           // fidvalue = fidvalue.replaceAll("\\D+","");
            Log.e("ID",catid);

        } else {
            if(activity.equalsIgnoreCase("musicnew")){
                catid=contentid;
                fidvalue=fid;
       ...
       /* if(catid!=null){
            URLTWO=URLS+"&fid="+fidvalue+"&mid="+catid;
        ...
        imageview.setImageUrl(getimage,mImageLoader);
       ...
       /* Intent get=getIntent();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayers.stop();
               /* Intent backmusicplayer=new Intent(getApplicationContext(),MusicnewRealeaseDetailpage.class);
                backmusicplayer.putExtra("ID",fidvalue);
                backmusicplayer.putExtra("TITLE", gettitle);
                backmusicplayer.putExtra("DATE", getdate);
                backmusicplayer.putExtra("IMAGE", getimage);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayers.stop();
                Intent menumusicplayer=new Intent(getApplicationContext(),MainActivityVersiontwo.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "musicnew");
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent signin=new Intent(Radiojockeyplayer.this,SigninpageActivity.class);
       ...
       /* favbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    Intent in=new Intent(MusicnewReleaseplayer.this,SigninpageActivity.class);
                    startActivity(in);
                }
            }
        });*/
