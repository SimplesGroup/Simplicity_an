 ...
 */
public class TabentertainmentRadio extends Fragment implements ChangeFont{
    RecyclerView recyclerview_tab_all;
    String URL="\thttp://simpli-city.in/request2.php?rtype=ent_alldatatest&key=simples&qtype=radio";
 ...
 private static    Recyclerviewtaballadapter recyclerview_tab_all_adapter;
  private static   List<ItemModel> modelListsradio=new ArrayList<ItemModel>();
    private boolean isFragmentLoaded=false;
    MediaPlayer mediaPlayer;
    FloatingActionButton fabentertainmentradio,fabplus;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabentertainmentradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsradio.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                 ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
...
//mediaPlayer=new MediaPlayer();
       ...
       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsradio, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsradio);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabentertainmentradio.setVisibility(View.VISIBLE);
                                }else {
                                    fabentertainmentradio.setVisibility(View.GONE);
                                }
                                if (!loading
