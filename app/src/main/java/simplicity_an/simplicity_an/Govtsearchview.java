 ...
 */
public class Govtsearchview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(Govtsearchview.this, MainPageEnglish.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menugovtsearch = new Intent(getApplicationContext(), MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backgovtsearch = new Intent(getApplicationContext(), GovernmentNotifications.class);
