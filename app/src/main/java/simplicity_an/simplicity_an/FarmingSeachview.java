 ...
 */
public class FarmingSeachview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(FarmingSeachview.this, MainPageEnglish.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufarmingsearch = new Intent(getApplicationContext(), MainPageEnglish.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              /*  Intent backfarmingsearch = new Intent(getApplicationContext(),FarmingAgricultureActivity.class);
