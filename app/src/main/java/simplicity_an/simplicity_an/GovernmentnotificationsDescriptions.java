 ...
 */
public class GovernmentnotificationsDescriptions extends AppCompatActivity {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*if(searchactivity_govt.equalsIgnoreCase("govtsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), Govtsearchview.class);
                    ...
                    Intent backgovtdesc = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
