 ...
 */
public class TabFarming extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL="\thttp://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=farming";
...
FloatingActionButton fabfarming,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
 private static    Recyclerviewtaballadapter recyclerview_tab_all_adapter;
  private static   List<ItemModel> modelListsfarming=new ArrayList<ItemModel>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabfarming.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsfarming.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                               ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
       ...
       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsfarming, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsfarming);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabfarming.setVisibility(View.VISIBLE);
                                }else {
                                    fabfarming.setVisibility(View.GONE);
                                }
                                if (!loading
