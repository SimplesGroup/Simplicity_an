...
Log.e("URL","hh"+itemmodel.getYoutubelink());
                ...
                if(itemmodel.getPdate().equals("null")||itemmodel.getPdate().equals("")){
                    userViewHolder.shortdescription.setText(Html.fromHtml( itemmodel.getShortdescription()));                 }else {                    if(itemmodel.getShortdescription().equals("")){                        userViewHolder.shortdescription.setText(Html.fromHtml(itemmodel.getPdate()));                     }else {                        userViewHolder.shortdescription.setText(Html.fromHtml(itemmodel.getPdate()+"&nbsp;"+"|"+"&nbsp;"+itemmodel.getShortdescription()));                     }                 }
                userViewHolder.shortdescription.setTypeface(pala);
               ...
               // userViewHolder.date.setText(itemmodel.getPdate());
                ...
                if(fontname.equals("sanfrancisco")){
                   ...
                   userViewHolder.title_item.setTypeface(sansbold);
                   userViewHolder.likescount.setTypeface(sansregular);
                   userViewHolder.commentscount.setTypeface(sansregular);                    userViewHolder.editername.setTypeface(sansregular);                    userViewHolder.shortdescription.setTypeface(sansregular);                    userViewHolder.title_item.setTextSize(17);                    userViewHolder.shortdescription.setTextSize(15);                    userViewHolder.item_type_name.setTypeface(sansregular);                    userViewHolder.editername.setTypeface(sansregular);                    userViewHolder.shortdescription.setLineSpacing(-0.3f,1f);                    userViewHolder.title_item.setLineSpacing(0,1f);
                }
                if(colorcodes.equals("#FFFFFFFF")){
                    if(fontname.equals("playfair")){
                        String playbold=  "fonts/PlayfairDisplayBold.ttf";
...
AddnewCommnent();
    ...
    public static class MyDialogFragmentviewone extends DialogFragment {
        NetworkImageView post_view_image_big;
        ImageLoader mImageLoader;
        ImageButton closedialog;
        TextView photostory_title,photostory_date;
        String images_to_load,title,date;
        public MyDialogFragmentviewone() {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            photostory_title=(TextView)root.findViewById(R.id.title);
            photostory_date=(TextView)root.findViewById(R.id.date);
            ...
            closedialog.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MyDialogFragmentviewone.this.dismiss();
