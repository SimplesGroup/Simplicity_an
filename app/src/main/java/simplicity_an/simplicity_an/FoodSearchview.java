    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(FoodSearchview.this, MainPageEnglish.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufoodsearch = new Intent(getApplicationContext(), MainPageEnglish.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backfoodsearch = new Intent(getApplicationContext(), FoodActivity.class);
...
*/
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                editor.commit();
                Intent i = new Intent(getApplicationContext(), FoodAndCookDescriptionPage.class);
                i.putExtra("ID", bid);
