 ...
 */
public class TabEntertainmentAll extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldata&key=simples";
