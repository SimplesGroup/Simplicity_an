 ...
 */
public class TabEntertainmentAll extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldatatest&key=simples";
 ...
 private static    Recyclerviewtaballadapter recyclerview_tab_all_adapter;
  private static   List<ItemModel> modelListsenall=new ArrayList<ItemModel>();
    private boolean isFragmentLoaded=false;
    MediaPlayer mediaPlayer;
    public static final String Activity = "activity";
    public static final String CONTENTID = "contentid";

    FloatingActionButton fabentertainmentall,fabplus;
...
String fontname;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabentertainmentall=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        if(colorcodes.equals("#FFFFFFFF")){
            fabentertainmentall.setImageResource(R.mipmap.uptamil);
        }
        else{
            fabentertainmentall.setImageResource(R.mipmap.uparrow);
        }
        fabentertainmentall.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabentertainmentall.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
...
//mediaPlayer=new MediaPlayer();
        ...
        //getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsenall, recyclerview_tab_all);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsenall.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                 ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsenall);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabentertainmentall.setVisibility(View.VISIBLE);
                                }else {
                                    fabentertainmentall.setVisibility(View.GONE);
                                }
                                if (!loading
