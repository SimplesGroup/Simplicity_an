...
public class Tabeventtomorrow extends Fragment implements ChangeFont{
 ...
 private static    Recyclerviewtaballadapter recyclerview_tab_all_adapter;
  private static   List<ItemModel> modelListstomo=new ArrayList<ItemModel>();
...
OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabevent.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListstomo.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                               ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
        ...
        // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListstomo,recyclerview_tab_all);
    ...
    StringRequest getDataFromTheServer(final int requestCount) {
        ...
        StringRequest request=new StringRequest(Request.Method.POST, Configurl.api_new_url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("qtype","tomorrow_event");
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListstomo);
    }
   ...
   /* public void onStop() {
    ...
    class Recyclerviewtaballadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch ( viewType ) {
                case VIEW_TYPE_ITEM:
                    ViewGroup vImage = (ViewGroup) mInflater.inflate ( R.layout.feed_item_versionfour_event, parent, false );
        ...
        class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                if (viewType == VIEW_TYPE_ITEM) {
                    ...
                    return new Tabevent.MyDialogFragment.UserViewHolder(view);
                } else if (viewType == VIEW_TYPE_LOADING) {
                    View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_loading_item, parent, false);
                    return new Tabevent.MyDialogFragment.LoadingViewHolder(view);
                }
                return null;
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                if (holder instanceof Tabevent.MyDialogFragment.UserViewHolder) {
                ...
                } else if (holder instanceof Tabevent.MyDialogFragment.LoadingViewHolder) {
                    Tabevent.MyDialogFragment.LoadingViewHolder loadingViewHolder = (Tabevent.MyDialogFragment.LoadingViewHolder) holder;
                    loadingViewHolder.progressBar.setIndeterminate(true);
                }
