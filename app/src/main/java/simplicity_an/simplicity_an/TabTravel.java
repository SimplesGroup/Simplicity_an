 ...
 */
public class TabTravel extends Fragment implements ChangeFont{
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=travels";
...
FloatingActionButton fabtravel,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
    private static Recyclerviewtaballadapter recyclerview_tab_all_adapter;
    private static List<ItemModel> modelListstravel=new ArrayList<ItemModel>();
...
OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabtravel.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListstravel.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                 ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);

            }
        });
       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListstravel, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListstravel);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabtravel.setVisibility(View.VISIBLE);
                                }else {
                                    fabtravel.setVisibility(View.GONE);
                                }
                                if (!loading
