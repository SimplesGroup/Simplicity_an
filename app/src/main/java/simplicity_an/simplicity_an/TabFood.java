...
FloatingActionButton fabfood,fabplus;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.equals("#FFFFFFFF")){
            fabfood.setImageResource(R.mipmap.uptamil);
        }
        else{
            fabfood.setImageResource(R.mipmap.uparrow);
        }
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
