...
public class TabFood extends Fragment {
    ...
    String URL="http://simpli-city.in/request2.php?rtype=alldata&key=simples&qtype=food";
...
FloatingActionButton fabfood,fabplus;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabfood=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabfood.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    public void OnItemClick(View view, int position) {
                        switch (view.getId()) {
                            case R.id.listlayout_taball:
                                ...
                                String qtype = ((ItemModel) modelList.get(position)).getQtypemain();
                                ...
                                if(itemmodel.getQtype().equals("Sponsered")||itemmodel.getQtype().equals("Sponsored")){
                                    ...
                                    if(qtype.equals("food")||qtype.equals("foodtip")) {
                                        if (qtype.equals("food")) {
