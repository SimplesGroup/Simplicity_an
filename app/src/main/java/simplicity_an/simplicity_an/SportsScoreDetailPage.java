 ...
 */
public class SportsScoreDetailPage extends Activity {
...
back=(ImageButton)findViewById(R.id.btn_1);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  Intent back=new Intent(SportsScoreDetailPage.this,Sports.class);
                startActivity(back);
                finish();*/
                onBackPressed();
            }
        ...
        main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menu=new Intent(SportsScoreDetailPage.this,MainActivityVersiontwo.class);
                startActivity(menu);
                finish();
            }
        });
