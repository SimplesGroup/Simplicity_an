...
public class TabMusic extends Fragment {
    ...
    String URL="http://simpli-city.in/request2.php?rtype=alldata&key=simples&qtype=music";
    ...
    FloatingActionButton fabmovies,fabplus;
...
MediaPlayer mediaPlayer;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabmovies=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabmovies.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabmovies.setVisibility(View.VISIBLE);
                                }else {
                                    fabmovies.setVisibility(View.GONE);
                                }
                                if (!loading
...
*/
                            ...
                            case R.id.taball_play_pause:
                               // final String mCurrentPlayingPosition=itemmodel.getPlayurl();
                                ...
                                userViewHolder.play.setImageResource(R.mipmap.pauseradio);
