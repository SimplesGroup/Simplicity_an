...
/**
 * Created by kuppusamy on 5/11/2016.
 */
public class NewsSearchview extends AppCompatActivity {
   ...
   CoordinatorLayout mCoordinator;
    ...
    String searchvalue_news,searchvalue_news_value;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       supportRequestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        setContentView(R.layout.newssearchview);
        ...
        searchvalue_news=sharedpreferences.getString(MYACTIVITYSEARCH,"");
        searchvalue_news_value=sharedpreferences.getString(MYACTIVITYSEARCHVALUE,"");
...
if(searchvalue_news.equalsIgnoreCase("newssearch")){

    search_value=searchvalue_news_value;
    ...
    Search();
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(NewsSearchview.this, MainPageEnglish.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menunewssearch = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
                startActivity(menunewssearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backnewssearch = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
                startActivity(backnewssearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        search=(SearchView)findViewById(R.id.search_news);
        Toolbartitle.setText("News");
        recycler = (RecyclerView)findViewById(R.id.searchview_news_recyclerview);
...
*/
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "newssearch");
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=news&q="+search_value+"&page="+requestCount;
