...
requestQueue.add(request);
    ...
    @Override
    public List<ShippingModel> Addressupdateornew(Context context, final String rtype,final String userids, String name, String phone, String email, String address, String location, String pincode, String landmark, String state, String shippingaddress_id) {
        requestQueue= Volley.newRequestQueue(context);
        addresslist.clear();
        StringRequest request=new StringRequest(Request.Method.POST, Configurl.exploreurl, new Response.Listener<String>() {
            @Override
