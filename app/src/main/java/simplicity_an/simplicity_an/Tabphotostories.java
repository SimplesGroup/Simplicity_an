...
public class Tabphotostories extends Fragment {
    ...
    String URL="http://simpli-city.in/request2.php?rtype=alldata&key=simples&qtype=photostories";
...
album.add(images);
    ...
    class ItemModel{
        ...
        private String description,albumimage;
    ...
    class Recyclerviewtaballadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
               ...
               /* CharSequence timeAgo = DateUtils.getRelativeTimeSpanString(
                ...
                if (itemmodel.getAlbumcount()==0) {
                    ...
                    for (j = 0; j < itemmodel.getAlbum().size(); j++) {
                        ...
                        System.out.println("four -->" + itemmodel.getAlbum().size());
                        // holder.textViewPowers_one.setText(powerstwo);
                        // holder.textViewPowers_two.setText(powerstwo);
                        // holder.textViewPowers_three.setText(powerstwo);
                        // holder.textViewPowers_four.setText(powerstwo);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if(viewType == VIEW_TYPE_ITEM) {
                View view = LayoutInflater.from(getActivity()).inflate(R.layout.feed_item_versiontwo_photo, parent, false);
