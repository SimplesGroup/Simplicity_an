...
/**
 * Created by kuppusamy on 10/18/2016.
 */
public class Tabphotostories extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all_news;
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldatatest&key=simples&qtype=photostories";
    ...
    private static List<ItemModel> modelListsphoto=new ArrayList<ItemModel>();
       ...
       // Log.e("Colorcode",colorcodes);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsphoto.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);

            }
        });
        //getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsphoto,recyclerview_tab_all_news);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsphoto);
    }
...
*/
    ...
    public static class MyDialogFragmentmultiple extends DialogFragment {
        ...
        String likes_to_load,title,date;
