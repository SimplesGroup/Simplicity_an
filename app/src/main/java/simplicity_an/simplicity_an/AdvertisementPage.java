...
public class AdvertisementPage extends AppCompatActivity {
    ...
    String URL="http://simpli-city.in/request_ads.php?category=";
    String URLTWO;
  ...
  RecyclerViewAdapter rcAdapter;
    ...
    //  tv = (TextView) findViewById(R.id.textView_titlename);
     ...
     /* pdate = (TextView) findViewById(R.id.authordate);
     ...
     authorname = (TextView) findViewById(R.id.author);*/
      ...
      //articleoftheday.setText("Article of the day");
       ...
       thump = (NetworkImageView) findViewById(R.id.thumbnailone);*/
        ...
        JsonObjectRequest jsonreq = new JsonObjectRequest(Request.Method.GET, URLTWO, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                if (response != null) {
                    pdialog.dismiss();
                    Log.e("JSON","json"+response.toString());
                    //dissmissDialog();
        ...
        if(myprofileid!=null){
            ...
            loadmore_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Articledescription.MyDialogFragment frag;
                    frag = new Articledescription.MyDialogFragment();
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    editor.putString(Activity, "adsdesc");
...
//                model.setSource(obj.getString("source"));
             ...
             // tv.setText(Html.fromHtml(obj.getString("title")));
              ...
              //  post_likes_count=obj.getInt("fav_count");
               ...
               // articleoftheday.setVisibility(View.GONE);
             ...
             /* thump.setDefaultImageResId(R.mipmap.ic_launcher);
                ...
                /*if(obj.getString("source").equals("null")||obj.equals("")){
                    authorname.setVisibility(View.GONE);
                }else {
                    authorname.setText(Html.fromHtml("By&nbsp;" + "" + obj.getString("source")));
                }
...
String yy="http://simpli-city.in/education-detail.php?nid=444&isnotify=n";
             ...
             try {
                    String adurl= URLDecoder.decode(obj.getString("ad_url"),"utf-8");
                 //description.loadUrl("http://simpli-city.in");
              // description.loadUrl("https://support.google.com/googleplay/android-developer/answer/113476");
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            } else if (holder instanceof Articledescription.LoadingViewHolder) {
                Articledescription.LoadingViewHolder loadingViewHolder = (Articledescription.LoadingViewHolder) holder;
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        //Need this to set the title of the app bar
        CollapsingToolbarLayout mCollapsingToolbarLayout;
      MyDialogFragment.RecyclerViewAdapter rcAdapter;
        ProgressDialog pdialog;
        RequestQueue requestQueue;
        private int requestCount = 1;
        JsonObjectRequest jsonReq;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            rcAdapter = new MyDialogFragment.RecyclerViewAdapter(commentlist,recycler);
        ...
        private void parseJsonFeed(JSONObject response) {
            try {
                ...
                for (ii = 0; ii < feedArray.length(); ii++) {
                    ...
                    MyDialogFragment.ItemModels model = new MyDialogFragment.ItemModels();
                    //FeedItem model=new FeedItem();
                    String image = obj.isNull("thumb") ? null : obj
                            .getString("thumb");
                    model.setProfilepic(image);
        ...
        class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                ...
                if (viewType == VIEW_TYPE_ITEM) {
                    ...
                    return new Articledescription.MyDialogFragment.UserViewHolder(view);
                } else if (viewType == VIEW_TYPE_LOADING) {
                    View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_loading_item, parent, false);
                    return new Articledescription.MyDialogFragment.LoadingViewHolder(view);
                }
                return null;
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                if (holder instanceof MyDialogFragment.UserViewHolder) {
                    ...
                    MyDialogFragment.ItemModels itemmodel = commentlist.get(position);
