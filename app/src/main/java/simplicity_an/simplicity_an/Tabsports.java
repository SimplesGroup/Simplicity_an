 ...
 */
public class Tabsports extends Fragment implements ChangeFont {
    RecyclerView recyclerview_tab_all;
    String URL = "http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=sports";
...
FloatingActionButton fabsports,fabplus;
    String myprofileid;
    LinearLayoutManager lLayout;
    private static Recyclerviewtaballadapter recyclerview_tab_all_adapter;
    private static List<ItemModel> modelListssports = new ArrayList<ItemModel>();
...
String fontname;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabsports=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        if(colorcodes.equals("#FFFFFFFF")){
            fabsports.setImageResource(R.mipmap.uptamil);
        }
        else{
            fabsports.setImageResource(R.mipmap.uparrow);
        }
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabsports.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListssports.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);

            }
        });

       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListssports, recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListssports);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabsports.setVisibility(View.VISIBLE);
                                }else {
                                    fabsports.setVisibility(View.GONE);
                                }
                                if (!loading
