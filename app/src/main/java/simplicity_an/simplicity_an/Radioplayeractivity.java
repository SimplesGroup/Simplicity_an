...
public class Radioplayeractivity extends AppCompatActivity implements MediaPlayer.OnCompletionListener{
   ...
   private Handler myHandler = new Handler();;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("TYPEVALUEID",String.valueOf(radio_urltype).toString());
       ...
       // AppControllers.getInstance().addToRequestQueue(jsonreq);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  Intent back_radio=new Intent(Radioplayeractivity.this,RadioActivity.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent home_radio=new Intent(Radioplayeractivity.this,MainPageEnglish.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "radio");
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent signin=new Intent(Radioplayeractivity.this,SigninpageActivity.class);
       ...
       favbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent in=new Intent(Radioplayeractivity.this,SigninpageActivity.class);
                    startActivity(in);
                }
            }
        });
