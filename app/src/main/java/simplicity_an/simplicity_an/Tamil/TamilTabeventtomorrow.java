...
public class TamilTabeventtomorrow extends Fragment{
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=tomorrow_event&language=2";
...
OnFragmentInteractionListener mListener;
    ...
    static class Userviewholdertaball extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        ImageButton share_imagebutton,like_imagebutton,comment_imagebutton;
    ...
    class Recyclerviewtaballadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof Userviewholdertaball) {
                ...
                final Typeface playfair = Typeface.createFromAsset(getActivity().getAssets(), simplycity_title);
