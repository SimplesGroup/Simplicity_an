 ...
 */
public class Tamilmusic extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldata&key=simples&language=2&qtype=music";
