 ...
 */
public class Tamiljob extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=job&language=2";
...
OnFragmentInteractionListener mListener;
    ...
    class Recyclerviewtaballadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch ( viewType ) {
                case VIEW_TYPE_ITEM:
                    ViewGroup vImage = (ViewGroup) mInflater.inflate ( R.layout.feed_item_versionfour_event_tamil, parent, false );
