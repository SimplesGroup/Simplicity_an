 ...
 */
public class TamilEntertainmentall extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldatatest&key=simples&language=2";
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && !isFragmentLoaded ) {
            ...
            Log.e("TAB:","entertainmentall");
        }
    }
    public TamilEntertainmentall() {
