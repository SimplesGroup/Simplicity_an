 ...
 */
public class TamilEventSearchview extends AppCompatActivity {
  ...
  CoordinatorLayout mCoordinator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eventssearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("eventsearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(TamilEventSearchview.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menueventsearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menueventsearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              /*  Intent backeventsearch = new Intent(getApplicationContext(),TamilEvents.class);
                startActivity(backeventsearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_event);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_event);
        Toolbartitle.setText("Events");
        recycler = (RecyclerView)findViewById(R.id.searchview_event_recyclerview);
...
*/
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "eventsearch");
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=event&q="+search_value+"&page="+requestCount;
