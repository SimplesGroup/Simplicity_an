 ...
 */
public class FoodSearchviewTamil extends AppCompatActivity {
   ...
   ProgressDialog pdialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.foodsearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("foodsearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(FoodSearchviewTamil.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufoodsearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menufoodsearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backfoodsearch = new Intent(getApplicationContext(), FoodActivityTamil.class);
                startActivity(backfoodsearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_food);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_food);
        Toolbartitle.setText("Food & Cooking");
        recycler = (RecyclerView)findViewById(R.id.searchview_food_recyclerview);
...
*/
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "foodsearch");
                editor.putString(MYACTIVITYSEARCHVALUE, search_value);
                editor.commit();
                Intent i = new Intent(getApplicationContext(), FoodAndCookDescriptionPagetamil.class);
                i.putExtra("ID", bid);
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=food&q="+search_value+"&page="+requestCount;
