 ...
 */
    ...
    public class Radioplayerfavplaylisttamil extends AppCompatActivity implements MediaPlayer.OnCompletionListener{
          ...
          //  AppController.getInstance().addToRequestQueue(jsonreq);
            ...
            back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    /*Intent back_radio=new Intent(Radioplayerfavplaylisttamil.this,MainPageTamil.class);
            ...
            home.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent home_radio=new Intent(Radioplayerfavplaylisttamil.this,MainActivityTamil.class);
            ...
            comment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(myprofileid!=null) {
                        ...
                        SharedPreferences.Editor editor = sharedpreferences.edit();
                        editor.putString(Activity, "radiofavtamil");
                        editor.putString(CONTENTID, catid);
                        editor.commit();
                        Intent signin=new Intent(Radioplayerfavplaylisttamil.this,SigninpageActivity.class);
            ...
            favbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (myprofileid != null) {
                        ...
                        editor.putString(CONTENTID, catid);
                        editor.commit();
                        Intent in=new Intent(Radioplayerfavplaylisttamil.this,SigninpageActivity.class);
                        startActivity(in);
                    }
                }
            });
