 ...
 */
public class DoitDescriptiontamil extends AppCompatActivity {
...
ScrollView scrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("doitdesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
      ...
      //  recycler_comment.addItemDecoration(new DividerItemDecoration(getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent backdoit = new Intent(getApplicationContext(), MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menudoit = new Intent(getApplicationContext(), MainPageTamil.class);
       ...
       comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "doitdesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin=new Intent(DoitDescriptiontamil.this,SigninpageActivity.class);
    ...
    private void parseJsonFeed(JSONArray response) {
        ImageLoader    mImageLoader = simplicity_an.simplicity_an.MySingleton.getInstance(DoitDescriptiontamil.this).getImageLoader();
        try {
