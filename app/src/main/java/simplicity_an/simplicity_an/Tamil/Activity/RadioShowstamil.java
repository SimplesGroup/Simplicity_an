 ...
 */
public class RadioShowstamil extends Fragment {
    private LinearLayoutManager lLayout;
    private List<ItemModel> modelList=new ArrayList<ItemModel>();
    private String URL="http://simpli-city.in/request2.php?rtype=radio&key=simples&type=0";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        getData();
        rView.addOnItemTouchListener(new RadioActivitytamil.RecyclerTouchListener(getActivity(), rView, new RadioActivitytamil.ClickListener() {
            public void onClick(View view, int position) {
                ...
                if(post==4||post==3) {
                    ...
                    if(myprofileid!=null){
                        Uloaddataserver();
                        Intent fooddescription = new Intent(getActivity(), Radioplayeractivitytamil.class);
                        ...
                        fooddescription.putExtra("TYPEVALUE",0);
