 ...
 */
public class ScienceSearchviewtamil extends AppCompatActivity {
   ...
   CoordinatorLayout mCoordinator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sciencesearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("Sciencesearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(ScienceSearchviewtamil.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menusciencesearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menusciencesearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backsciencesearch = new Intent(getApplicationContext(), ScienceandTechnologytamil.class);
                startActivity(backsciencesearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_science);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_science);
        Toolbartitle.setText("Science & Technology");
        recycler = (RecyclerView)findViewById(R.id.searchview_science_recyclerview);
...
Search();
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "Sciencesearch");
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=science&q="+search_value+"&page="+requestCount;
