 ...
 */
public class RadioPlayerPagetamil extends AppCompatActivity implements MediaPlayer.OnCompletionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent back_radio=new Intent(RadioPlayerPagetamil.this,MainPageTamil.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent home_radio=new Intent(RadioPlayerPagetamil.this,MainActivityTamil.class);
