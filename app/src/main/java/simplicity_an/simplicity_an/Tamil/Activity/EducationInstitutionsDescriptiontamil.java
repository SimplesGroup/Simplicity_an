 ...
 */
public class EducationInstitutionsDescriptiontamil extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("eduintsdesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  Intent back_article = new Intent(getApplicationContext(), MainPageTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if(myprofileid!=null) {
                   ...
                   SharedPreferences.Editor editor = sharedpreferences.edit();
                   editor.putString(Activity, "eduintsdesctamil");
                   editor.putString(CONTENTID, notifiid);
                   editor.commit();
                    Intent signin=new Intent(EducationInstitutionsDescriptiontamil.this,SigninpageActivity.class);
...
auditorium_label.setText("Auditorium");
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerViewHolders> {
        ...
        public void onBindViewHolder(RecyclerViewHolders holder, int position) {
            ...
            mImageLoader = MySingleton.getInstance(EducationInstitutionsDescriptiontamil.this).getImageLoader();
