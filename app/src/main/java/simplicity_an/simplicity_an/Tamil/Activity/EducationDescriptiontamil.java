 ...
 */
public class EducationDescriptiontamil extends AppCompatActivity {
    ...
    String URL = "http://simpli-city.in/request2.php?rtype=education&key=simples&nid=";
    String URLTWO;
    String sourcelink;
    String titl, name;
    ...
    String URLCOMMENT = "http://simpli-city.in/request2.php?rtype=viewcomment&key=simples&qtype=education&id=";
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "edunewsdesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin=new Intent(EducationDescriptiontamil.this,SigninpageActivity.class);
        ...
        try {
            ...
            for (int i = 0; i < response.length(); i++) {
               ...
               ItemModel model = new ItemModel();
                ...
                model.setSource(obj.getString("publisher_name"));
                ...
                if (obj.getString("reporter_name").equals("") || obj.getString("reporter_name").equals("null")) {
                    source_reporter_name.setText(Html.fromHtml(obj.getString("publisher_name")));
                } else {
                    if(obj.getString("publisher_name").equals("")){
                        source_reporter_name.setText(Html.fromHtml(obj.getString("reporter_name")+"&nbsp;"));
                    }else {
                        source_reporter_name.setText(Html.fromHtml(obj.getString("reporter_name") + "&nbsp;"+"|"+"&nbsp;"+obj.getString("publisher_name")));
                    }
                }
                pdate.setText(Html.fromHtml( obj.getString("publisher_name")));
