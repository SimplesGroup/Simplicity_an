 ...
 */
public class FarmingAgricultureActivitytamil extends AppCompatActivity {
     List<ItemModel> modelList=new ArrayList<ItemModel>();
    String URL="http://simpli-city.in/request2.php?key=simples&rtype=farming&language=2&page=";
   ListView listview;
...
CollapsingToolbarLayout mCollapsingToolbarLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent home_intent=new Intent(getApplicationContext(),MainPageTamil.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent search_intent=new Intent(getApplicationContext(),FarmingSeachviewtamil.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(FarmingAgricultureActivitytamil.this,MainPageTamil.class);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof ViewitemTwoholder){
                if(mImageLoader==null)
                    mImageLoader = MySingleton.getInstance(FarmingAgricultureActivitytamil.this).getImageLoader();
                ...
                if(itemmodel.getTypeid()==4){
                    if (mImageLoader == null)
                        mImageLoader = CustomVolleyRequest.getInstance(FarmingAgricultureActivitytamil.this).getImageLoader();
