 ...
 */
public class RadioPlaylisttamil extends AppCompatActivity {
       ...
       mainpage=(ImageButton)findViewById(R.id.btn_radioplayhome);
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*Intent radiopage=new Intent(RadioPlaylisttamil.this,MainPageTamil.class);
        ...
        mainpage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent radiopage=new Intent(RadioPlaylisttamil.this,MainActivityTamil.class);
                startActivity(radiopage);
                finish();
            }
        });
        ...
        rView.addOnItemTouchListener(new RadioActivitytamil.RecyclerTouchListener(getApplicationContext(), rView, new RadioActivitytamil.ClickListener() {
            public void onClick(View view, int position) {
               ...
               // int favid= ((ItemModel) modelList.get(position)).getFavourite();
                ...
                if(myprofileid!=null){
                  //  Uloaddataserver();
                    Intent fooddescription = new Intent(getApplicationContext(), Radioplayerfavplaylisttamil.class);
