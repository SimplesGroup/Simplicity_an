...
import simplicity_an.simplicity_an.RadioprogramsInnerpage;
import simplicity_an.simplicity_an.SigninpageActivity;
import simplicity_an.simplicity_an.Tamil.MainActivityTamil;


public class Radioplayeractivitytamil extends AppCompatActivity implements MediaPlayer.OnCompletionListener{
   ...
   private Handler myHandler = new Handler();;
    ...
    private String URL="http://simpli-city.in/request2.php?rtype=radio&key=simples&type=";
       ...
       // catid=get.getStringExtra("ID");
        if(activity==null){
           ...
           catid = catid.replaceAll("\\D+","");
            ...
            if(activity.equalsIgnoreCase("radiotamil")){
                catid=contentid;
       ...
       // AppControllers.getInstance().addToRequestQueue(jsonreq);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  Intent back_radio=new Intent(Radioplayeractivitytamil.this,MainPageTamil.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent home_radio=new Intent(Radioplayeractivitytamil.this,MainActivityTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "radiotamil");
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent signin=new Intent(Radioplayeractivitytamil.this,SigninpageActivity.class);
       ...
       favbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    editor.putString(CONTENTID, catid);
                    editor.commit();
                    Intent in=new Intent(Radioplayeractivitytamil.this,SigninpageActivity.class);
                    startActivity(in);
                }
            }
        });
...
next.setOnClickListener(new View.OnClickListener() {
    ...
    private JsonObjectRequest getDataFromTheServer(int requestCount) {
        ...
        URLTHREE=URL+radio_urltype+"&page="+requestCount;
