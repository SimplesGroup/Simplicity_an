 ...
 */
public class GovernmentNotificationstamil extends AppCompatActivity {
     List<ItemModel> modelList=new ArrayList<ItemModel>();
    String URL="http://simpli-city.in/request2.php?rtype=govtnotification&key=simples&language=2&page=";
  ...
  String TAG_REQUEST = "MY_TAG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.governmentnotifications);
        ...
        menu=(ImageButton)findViewById(R.id.btn_govthome);
        back=(ImageButton)findViewById(R.id.btn_govtback);
        search=(ImageButton)findViewById(R.id.btn_govtsearch);
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent search_intent=new Intent(GovernmentNotificationstamil.this,Govtsearchviewtamil.class);
     ...
     menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menu=new Intent(GovernmentNotificationstamil.this,MainPageTamil.class);
                startActivity(menu);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* try {
                    Intent back = new Intent(GovernmentNotificationstamil.this, MainPageTamil.class);
                    startActivity(back);
                    finish();
                }catch (Exception e){
        ...
        Toolbartitle.setText("அரசு அறிவிப்பு");

        recycler = (RecyclerView)findViewById(R.id.government_recyclerview);
        ...
        notification=(ImageButton)findViewById(R.id.btn_govtprofile) ;
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(GovernmentNotificationstamil.this,MainPageTamil.class);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof ViewitemTwoholder){
                if(mImageLoader==null)
                    mImageLoader = CustomVolleyRequest.getInstance(GovernmentNotificationstamil.this).getImageLoader();
