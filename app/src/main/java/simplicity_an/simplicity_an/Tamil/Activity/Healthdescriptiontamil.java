 ...
 */
public class Healthdescriptiontamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("healthdesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*if(searchactivity_health.equalsIgnoreCase("healthsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), HealthSearchviewtamil.class);
                    ...
                    Intent backhealthdesc = new Intent(getApplicationContext(), MainPageTamil.class);
...
*/
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menuhealthdesc = new Intent(getApplicationContext(), MainPageTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "healthdesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin=new Intent(Healthdescriptiontamil.this,SigninpageActivity.class);
