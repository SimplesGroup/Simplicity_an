...
/**
 * Created by kuppusamy on 2/4/2016.
 */
public class Govtdescriptiontamil extends AppCompatActivity {
    ...
    String URL="http://simpli-city.in/request2.php?rtype=govtnotification&key=simples&gid=";
    String URLTWO;
    String titl;
    ...
    String searchnonitiid,searchactivity_govt;
    ...
    String URLCOMMENT = "http://simpli-city.in/request2.php?rtype=viewcomment&key=simples&qtype=govt&id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.govt_notify_description);
        sharedpreferences =  getSharedPreferences(mypreference,
                Context.MODE_PRIVATE);
        searchactivity_govt=sharedpreferences.getString(MYACTIVITYSEARCH,"");
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("govtdesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
       ...
       // recycler_comment.addItemDecoration(new DividerItemDecoration(getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        RequestQueue  queues = MySingleton.getInstance(this.getApplicationContext()).
                getRequestQueue();
requestQueue=Volley.newRequestQueue(this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*if(searchactivity_govt.equalsIgnoreCase("govtsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), Govtsearchviewtamil.class);
                    ...
                    Intent backgovtdesc = new Intent(getApplicationContext(), MainPageTamil.class);
                    startActivity(backgovtdesc);
                    finish();
                }*/
onBackPressed();
            }
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menugovtdesc = new Intent(getApplicationContext(), MainPageTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "govtdesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin=new Intent(Govtdescriptiontamil.this,SigninpageActivity.class);
    ...
    class ItemModel {
        ...
        private String category_name,source,sourcelink;
