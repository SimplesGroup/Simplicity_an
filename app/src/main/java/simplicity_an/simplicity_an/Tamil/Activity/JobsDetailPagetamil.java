    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent backjobdetail=new Intent(getApplicationContext(),JobsActivitytamil.class);
...
applyjob.setOnClickListener(new View.OnClickListener() {
    ...
    private void setupViewPager(ViewPager mPager) {
        ...
        adapter.addFragment(new FragmentJobDescriptiontamil(), "Job Description");
        adapter.addFragment(new FragmentEmployerinfotamil(), "Employee Info");
