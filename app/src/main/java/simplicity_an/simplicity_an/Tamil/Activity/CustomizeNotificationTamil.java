 ...
 */
public class CustomizeNotificationTamil extends AppCompatActivity {
...
back.setImageResource(R.mipmap.backtamil);
       ...
       travel_textview.setTypeface(tf);
        ...
        audiovideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent happening=new Intent(getApplicationContext(),MainPageTamil.class);
                startActivity(happening);
            }
        });
