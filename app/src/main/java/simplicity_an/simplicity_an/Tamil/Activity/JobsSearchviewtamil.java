 ...
 */
public class JobsSearchviewtamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent backjobsearch = new Intent(getApplicationContext(), JobsActivitytamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menujobsearch = new Intent(getApplicationContext(), MainActivity.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(JobsSearchviewtamil.this,MainPageTamil.class);
