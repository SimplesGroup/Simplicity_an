 ...
 */
public class TamilNewsSearchview extends AppCompatActivity {
    ...
    Search();
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(TamilNewsSearchview.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menunewssearch = new Intent(getApplicationContext(), MainPageTamil.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             /*   Intent backnewssearch = new Intent(getApplicationContext(), NewsActivityTamil.class);
