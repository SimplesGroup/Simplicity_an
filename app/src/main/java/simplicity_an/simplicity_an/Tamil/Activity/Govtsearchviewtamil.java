 ...
 */
public class Govtsearchviewtamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.govtsearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("govtsearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(Govtsearchviewtamil.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menugovtsearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menugovtsearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*Intent backgovtsearch = new Intent(getApplicationContext(), GovernmentNotificationstamil.class);
                startActivity(backgovtsearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_govt);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_govt);
        Toolbartitle.setText("Govt Notifications");
        recycler = (RecyclerView)findViewById(R.id.searchview_govt_recyclerview);
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "govtsearch");
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=govt&q="+search_value+"&page="+requestCount;
