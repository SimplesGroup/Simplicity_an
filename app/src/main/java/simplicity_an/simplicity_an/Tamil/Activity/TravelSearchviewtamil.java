 ...
 */
public class TravelSearchviewtamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.travelssearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("travelsearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(TravelSearchviewtamil.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menutravelsearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menutravelsearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent backtravelsearch = new Intent(getApplicationContext(), TravelsActivitytamil.class);
                startActivity(backtravelsearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_travel);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_travel);
        Toolbartitle.setText("Travel");
        recycler = (RecyclerView)findViewById(R.id.searchview_travel_recyclerview);
...
Search();
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "travelsearch");
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=travels&q="+search_value+"&page="+requestCount;
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if(viewType == VIEW_TYPE_ITEM) {
                View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.feed_item_travel, parent, false);
