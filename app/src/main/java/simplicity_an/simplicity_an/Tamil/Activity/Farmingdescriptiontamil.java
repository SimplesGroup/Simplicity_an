...
public class Farmingdescriptiontamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("farmingdesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
       ...
       // recycler_comment.addItemDecoration(new DividerItemDecoration(getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* if(searchactivity_farming.equalsIgnoreCase("farmingsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), FarmingSeachviewtamil.class);
                    ...
                    Intent backfarming = new Intent(Farmingdescriptiontamil.this, MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufarming = new Intent(Farmingdescriptiontamil.this, MainPageTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "farmingdesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin = new Intent(Farmingdescriptiontamil.this, SigninpageActivity.class);
    ...
    private void parseJsonFeed(JSONObject response) {
        ImageLoader  mImageLoader = MySingleton.getInstance(Farmingdescriptiontamil.this).getImageLoader();
        try {
