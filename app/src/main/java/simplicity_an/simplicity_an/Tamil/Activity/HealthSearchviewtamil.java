 ...
 */
public class HealthSearchviewtamil extends AppCompatActivity {
   ...
   LinearLayoutManager mLayoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.healthsearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("healthsearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(HealthSearchviewtamil.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menuhealthsearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menuhealthsearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent backhealthsearch = new Intent(getApplicationContext(),HealthAndLivingtamil.class);
//                startActivity(backhealthsearch);
//                finish();
                onBackPressed();
            }
        });
        ...
        search=(SearchView)findViewById(R.id.search_health);
        Toolbartitle.setText("Health & Living");
        recycler = (RecyclerView)findViewById(R.id.searchview_health_recyclerview);
...
Search();
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "healthsearch");
    ...
    JsonObjectRequest getDataFromTheServer(int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=health&q="+search_value+"&page="+requestCount;
