 ...
 */
public class TravelsDescriptiontamil extends AppCompatActivity {
    TextView title,date,sourcelinknews,sourcelinksimplicity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.travelsdescription);
       ...
       /* Intent getnotifi=getIntent();
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("traveldesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        date=(TextView)findViewById(R.id.textView_date_sports);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              /*  if(searchactivity_travel.equalsIgnoreCase("travelsearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), TravelSearchviewtamil.class);
                    ...
                    Intent backtrveldesc = new Intent(TravelsDescriptiontamil.this, MainPageTamil.class);
...
onBackPressed();
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menutraveldesc = new Intent(TravelsDescriptiontamil.this, MainPageTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "traveldesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin = new Intent(TravelsDescriptiontamil.this, SigninpageActivity.class);
    ...
    private void parseJsonFeed(JSONObject response) {
        ImageLoader
                mImageLoader = MySingleton.getInstance(TravelsDescriptiontamil.this).getImageLoader();
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                //description.loadData(s, "text/html", null);
