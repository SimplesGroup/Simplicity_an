 ...
 */
public class FarmingSeachviewtamil extends AppCompatActivity {
  ...
  CoordinatorLayout mCoordinator;
   ...
   LinearLayoutManager mLayoutManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.farmingsearchview);
        ...
        if(searchvalue_event.equalsIgnoreCase("farmingsearch")){
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(FarmingSeachviewtamil.this,MainPageTamil.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menufarmingsearch = new Intent(getApplicationContext(), MainPageTamil.class);
                startActivity(menufarmingsearch);
                finish();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              /*  Intent backfarmingsearch = new Intent(getApplicationContext(),FarmingAgricultureActivitytamil.class);
                startActivity(backfarmingsearch);
                finish();*/
                onBackPressed();
            }
        });
        ...
        Toolbartitle=(TextView)findViewById(R.id.toolbar_title_farming);
        Toolbartitle.setTypeface(tf);
        search=(SearchView)findViewById(R.id.search_farming);
        Toolbartitle.setText("Agriculture");
        recycler = (RecyclerView)findViewById(R.id.searchview_farming_recyclerview);
...
*/
        ...
        recycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recycler, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                SharedPreferences.Editor editor = sharedpreferences.edit();
                editor.putString(MYACTIVITYSEARCH, "farmingsearch");
    ...
    JsonObjectRequest getDataFromTheServer( int requestCount) {
        ...
        URLSEARCH="http://simpli-city.in/request2.php?rtype=search&key=simples&qtype=farming&q="+search_value+"&page="+requestCount;
