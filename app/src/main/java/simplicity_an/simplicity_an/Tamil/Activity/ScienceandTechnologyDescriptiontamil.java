 ...
 */
public class ScienceandTechnologyDescriptiontamil extends AppCompatActivity {
    TextView titlename,date,sourcelinknews,sourcelinksimplicity;
    ...
    String URL="http://simpli-city.in/request2.php?rtype=science&key=simples&sid=";
    String URLTWO;
    ...
    String searchactivity_science,searchnonitiid;
    ...
    String URLCOMMENT = "http://simpli-city.in/request2.php?rtype=viewcomment&key=simples&qtype=science&id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.science_tech_description);
        sharedpreferences = getSharedPreferences(mypreference,
                Context.MODE_PRIVATE);
        searchactivity_science=sharedpreferences.getString(MYACTIVITYSEARCH,"");
...
requestQueue=Volley.newRequestQueue(this);
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("sciencedesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
       ...
       // recycler_comment.addItemDecoration(new DividerItemDecoration(getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* if(searchactivity_science.equalsIgnoreCase("Sciencesearch")){
                    Intent searchnotification = new Intent(getApplicationContext(), ScienceSearchviewtamil.class);
                    ...
                    Intent backsciencedesc = new Intent(getApplicationContext(), MainPageTamil.class);
                    startActivity(backsciencedesc);
                    finish();
                }
*/
                onBackPressed();
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menusciencedesc = new Intent(getApplicationContext(), MainActivityTamil.class);
                startActivity(menusciencedesc);
                finish();
            }
        });
        if(myprofileid!=null){
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (myprofileid != null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "sciencedesctamil");
                    editor.putString(CONTENTID, notifiid);
                    editor.commit();
                    Intent signin = new Intent(ScienceandTechnologyDescriptiontamil.this, SigninpageActivity.class);
        ...
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                if(obj.getString("source")==""||obj.getString("source").equalsIgnoreCase("null")){
                    ...
                    date.setText(Html.fromHtml(by) + "" + obj.getString("source") + "\n" + obj.getString("pdate"));
                }
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View root = inflater.inflate(R.layout.commentsciencefragment, container, false);
