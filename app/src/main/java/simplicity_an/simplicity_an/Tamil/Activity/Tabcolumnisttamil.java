...
public class Tabcolumnisttamil extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL = "http://simpli-city.in/request2.php?key=simples&rtype=alldatanew&qtype=columnist&language=2";
