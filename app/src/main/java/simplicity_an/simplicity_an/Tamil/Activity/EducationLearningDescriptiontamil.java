 ...
 */
public class EducationLearningDescriptiontamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(activity==null){
            ...
            if(activity.equalsIgnoreCase("edulearndesctamil")){
                notifiid=contentid;
                SharedPreferences.Editor editor = sharedpreferences.edit();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* if (searchnonitiid != null) {
                    Intent searchnotification = new Intent(getApplicationContext(), MainPageTamil.class);
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myprofileid!=null) {
                    ...
                    SharedPreferences.Editor editor = sharedpreferences.edit();
                    editor.putString(Activity, "edulearndesctamil");
