 ...
 */
public class Tamileducation extends Fragment {
    RecyclerView recyclerview_tab_all_news;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=education&language=2";
...
OnFragmentInteractionListener mListener;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && !isFragmentLoaded ) {
            ...
            Log.e("TAB:","TamilEducation");
        }
    }
    public Tamileducation() {
