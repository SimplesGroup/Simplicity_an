 ...
 */
public class Tamilbeyondnational extends Fragment {
    RecyclerView recyclerview_tab_all_news;
    String URL="http://simpli-city.in/request2.php?rtype=othernews&key=simples&language=2&qtype=national";
