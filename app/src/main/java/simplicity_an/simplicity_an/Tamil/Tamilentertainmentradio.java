 ...
 */
public class Tamilentertainmentradio extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldatatest&key=simples&qtype=radio&language=2";
    ...
    public Tamilentertainmentradio() {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#262626")){
                    ...
                    fabradio.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
