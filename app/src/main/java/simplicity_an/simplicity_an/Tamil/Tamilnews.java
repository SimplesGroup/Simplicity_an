            ...
            if (holder instanceof Userviewholdertaball) {
                ...
                if(itemmodel.getPdate().equals("null")||itemmodel.getPdate().equals("")){
                    ...
                    if(itemmodel.getShortdescription().equals("")){
                        ...
                        //userViewHolder.shortdescription.setText(itemmodel.getPdate()+""+"|"+""+TSCIIString);
                ...
                if(itemmodel.getEditername().equals("")){
                   ...
                   // String TSCIIString_title = TamilUtil.convertToTamil(TamilUtil.BAMINI, itemmodel.getQtype() + "&nbsp;"+"&nbsp;"+"&nbsp;" + "|" + "&nbsp;"+"&nbsp;"+"&nbsp;" + itemmodel.getEditername());
                   userViewHolder.item_type_name.setText(Html.fromHtml(itemmodel.getQtype() + "&nbsp;"+"&nbsp;"+"&nbsp;" + "|" + "&nbsp;"+"&nbsp;"+"&nbsp;" + itemmodel.getEditername()));
                    //userViewHolder.item_type_name.setText(Html.fromHtml(TSCIIString_title));
                        ...
                        switch (view.getId()) {
                            case R.id.listlayout_taball:
                                ...
                                if(type.equals("news")||type.equals("National")||type.equals("International")) {
                                    ...
                                    if(qtype.equals("சமையல் குறிப்பு")){
