 ...
 */
public class WreddingShopsDetail extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLPRODUCTLIST="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_shops&scat=";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.explore_wedding_shops_detail);
...
//tToast.makeText(getApplicationContext(),description,Toast.LENGTH_SHORT).show();
                ...
                venuedescription.setText(Html.fromHtml(jsonObject.getString("description").toString()));
