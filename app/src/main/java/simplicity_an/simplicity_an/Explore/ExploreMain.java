...
/**
 * Created by kuppusamy on 2/20/2017.
 */
public class ExploreMain extends AppCompatActivity {
    ...
    int requestcount=1;
    String URL="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=module";
    String URLALL;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        explore_title_textview = (TextView)findViewById(R.id.explore_text) ;
        coimbatore_title_textview=(TextView) findViewById(R.id.coimbatore_text);
        ...
        coimbatore_title_textview.setTypeface(tf);
        ...
        if(colorcodes.equalsIgnoreCase("#383838")){
            ...
            search_button.setBackgroundResource(R.color.theme3);
        }else if(colorcodes.equalsIgnoreCase("#7A4100")){
            search_button.setBackgroundResource(R.color.theme4);
        }else if(colorcodes.equalsIgnoreCase("#6E0138")){
            search_button.setBackgroundResource(R.color.theme5);
        }else if(colorcodes.equalsIgnoreCase("#00BFD4")){
            search_button.setBackgroundResource(R.color.theme6);
        }else if(colorcodes.equalsIgnoreCase("#185546")){
            search_button.setBackgroundResource(R.color.theme7);
        }else if(colorcodes.equalsIgnoreCase("#D0A06F")){
            search_button.setBackgroundResource(R.color.theme8);
        }else if(colorcodes.equalsIgnoreCase("#82C6E6")){
            search_button.setBackgroundResource(R.color.theme9);
        }else if(colorcodes.equalsIgnoreCase("#339900")){
            search_button.setBackgroundResource(R.color.theme10);
        }else if(colorcodes.equalsIgnoreCase("#CC9C00")){
            search_button.setBackgroundResource(R.color.theme11);
        }else if(colorcodes.equalsIgnoreCase("#00B09B")){
            search_button.setBackgroundResource(R.color.theme12);
        }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              /*  Intent city_page = new Intent(getApplicationContext(), MainPageEnglish.class);
                startActivity(city_page);*/
              onBackPressed();
...
LinearLayout explore_item_layout;
        public UserViewHolder(View itemView) {
            super(itemView);
            product_image = (NetworkImageView) itemView.findViewById(R.id.explore_product_category_image);
            product_name=(TextView)itemView.findViewById(R.id.explore_product_category_name);
    ...
    public class RecylerviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.explore_main_feed, parent, false);
...
if(holder instanceof UserViewHolder){
    ...
    userViewHolder.explore_item_layout.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
           // Toast.makeText(getApplicationContext(),"clicked"+itemmodel.getProductname(),Toast.LENGTH_SHORT).show();
            if(itemmodel.getHeading().equalsIgnoreCase("Events")){
Intent event_page=new Intent(getApplicationContext(),Events.class);
                startActivity(event_page);
            }else if(itemmodel.getHeading().equalsIgnoreCase("Jobs")){
                Intent job_page=new Intent(getApplicationContext(),JobsActivity.class);
                startActivity(job_page);

            }else if(itemmodel.getHeading().equalsIgnoreCase("Travels & Adventure")) {
                Intent travel_page = new Intent(getApplicationContext(), TravelsActivity.class);
                startActivity(travel_page);
            }
            else if(itemmodel.getHeading().equalsIgnoreCase("Directory Services")) {
                Intent directory_page = new Intent(getApplicationContext(), Directories.class);
                startActivity(directory_page);
            }
            else if(itemmodel.getHeading().equalsIgnoreCase("Recipes")) {
                Intent food_page = new Intent(getApplicationContext(), FoodActivity.class);
                startActivity(food_page);
            }else if(itemmodel.getHeading().equalsIgnoreCase("Buy Jewellery")||itemmodel.getHeading().equalsIgnoreCase("Online Grocery")) {
                Intent jewellandgrocery_page = new Intent(getApplicationContext(), GroceryPage.class);
                jewellandgrocery_page.putExtra("TITLE",itemmodel.getProductname());
                jewellandgrocery_page.putExtra("ID",itemmodel.getId());
                startActivity(jewellandgrocery_page);
            }else if(itemmodel.getId().equalsIgnoreCase("23")||itemmodel.getHeading().equalsIgnoreCase("Buy Online Milk")){
                Intent in=new Intent(getApplicationContext(),Milkpage.class);
                in.putExtra("TITLE",itemmodel.getProductname());
                startActivity(in);
            }else if(itemmodel.getId().equalsIgnoreCase("9")||itemmodel.getHeading().equalsIgnoreCase("Order Water")){
                Intent in=new Intent(getApplicationContext(),WaterListPage.class);
                in.putExtra("TITLE",itemmodel.getProductname());
                in.putExtra("ID","module="+itemmodel.getId());
                startActivity(in);
            }else if(itemmodel.getId().equalsIgnoreCase("20")||itemmodel.getHeading().equalsIgnoreCase("Music")){
                Intent music_page = new Intent(getApplicationContext(), MusicActivity.class);
                startActivity(music_page);
            }else if(itemmodel.getId().equalsIgnoreCase("21")||itemmodel.getHeading().equalsIgnoreCase("Theatre")){
                Intent music_page = new Intent(getApplicationContext(), Theatre.class);
                startActivity(music_page);
            }
            else if(itemmodel.getId().equalsIgnoreCase("24")||itemmodel.getHeading().equalsIgnoreCase("Wedding")){
                Intent music_page = new Intent(getApplicationContext(), WeddingCategory.class);
               music_page.putExtra("TITLE",itemmodel.getProductname());
                startActivity(music_page);
            }
            else if(itemmodel.getId().equalsIgnoreCase("15")||itemmodel.getHeading().equalsIgnoreCase("Rentals")){
                Intent music_page = new Intent(getApplicationContext(), RentalsMainPage.class);
                music_page.putExtra("TITLE",itemmodel.getProductname());
                startActivity(music_page);
            }else if(itemmodel.getId().equalsIgnoreCase("14")||itemmodel.getHeading().equalsIgnoreCase("Doctor on Call")){
                Intent music_page = new Intent(getApplicationContext(), DoctorOnCallMain.class);
                music_page.putExtra("TITLE",itemmodel.getHeading());
                startActivity(music_page);
            }
            else {
                Intent in=new Intent(getApplicationContext(),ProductListPage.class);
                in.putExtra("TITLE",itemmodel.getProductname());
                in.putExtra("ID","module="+itemmodel.getId());
                startActivity(in);
            }
