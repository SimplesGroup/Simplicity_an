 ...
 */
public class WeddingServices extends AppCompatActivity {
    ...
    int requestcount=1;
    String URL="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_services";
    String URLALL;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.explore_wedding_services);
            ...
            if(holder instanceof UserViewHolder){
                ...
                userViewHolder.explore_item_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            ...
                            Intent venue=new Intent(getApplicationContext(),WeddingServicelistPage.class);
