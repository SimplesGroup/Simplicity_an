 ...
 */
public class RentalsListPage extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLPRODUCTLIST="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=realestate";
    ...
    static class UserViewHolder extends RecyclerView.ViewHolder {
       ...
       TextView add_tocart;
        public UserViewHolder(View itemView) {
            super(itemView);
            product_image = (NetworkImageView) itemView.findViewById(R.id.explore_rentallist_image);
            product_name=(TextView)itemView.findViewById(R.id.explore_rentallist_title);
            product_price=(TextView)itemView.findViewById(R.id.explore_rentallist_date);

            add_tocart=(TextView) itemView.findViewById(R.id.explore_rentallist_cartbutton);
    ...
    public class RecylerviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.explore_rentalslist_feed, parent, false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof UserViewHolder) {
                ...
                userViewHolder.product_price.setText(itemmodel.getPdate());
                userViewHolder.add_tocart.setText("Rs."+itemmodel.getPrice());
                ...
                userViewHolder.add_tocart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                            ...
                            Intent detail=new Intent(getApplicationContext(),RentalDetailPage.class);
