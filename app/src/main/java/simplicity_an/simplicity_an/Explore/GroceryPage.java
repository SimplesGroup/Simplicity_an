...
/**
 * Created by kuppusamy on 2/23/2017.
 */
public class GroceryPage extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLJEWEL="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=jewellery_company";
    String URLGROCERY="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=grocery_company";
    String URLALL,URL;
    ...
    public class RecylerviewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.explore_grocery_jewel_feed, parent, false);
