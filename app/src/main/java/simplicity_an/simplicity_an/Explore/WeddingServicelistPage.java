 ...
 */
public class WeddingServicelistPage extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLVENUE="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_services&scat=";
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof UserViewHolder) {
                ...
                userViewHolder.explore_item_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    Intent detail=new Intent(getApplicationContext(),WeddingServicesDetailPage.class);
