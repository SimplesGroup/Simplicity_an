...
/**
 * Created by kuppusamy on 3/6/2017.
 */
public class MarriageDecorater  extends AppCompatActivity {
    ...
    int requestcount=1;
  String URLVENUE="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=venues";
    String URLDAIRIES="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_diaries";
    String URLALL,URL;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(id_intent.equalsIgnoreCase("1")||title_intent.equalsIgnoreCase("venue")){
            URL=URLVENUE;
        }else {
            URL=URLDAIRIES;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof UserViewHolder) {
                ...
                userViewHolder.explore_item_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(id_intent.equalsIgnoreCase("1")||title_intent.equalsIgnoreCase("venue")){
                            Intent in=new Intent(getApplicationContext(),WeddingVenueDetail.class);
                            in.putExtra("TITLE",itemmodel.getProductname());
                            in.putExtra("ID",itemmodel.getId());
                            startActivity(in);
                        }else {
                            Intent in=new Intent(getApplicationContext(),Weddingdairiesdetail.class);
                            in.putExtra("TITLE",itemmodel.getProductname());
                            in.putExtra("ID",itemmodel.getId());
                            startActivity(in);
                        }
                        /*if(id.equalsIgnoreCase("13")){
                            Intent in=new Intent(getApplicationContext(),JewelleryListPage.class);
                            in.putExtra("TITLE",itemmodel.getProductname());
                            in.putExtra("ID","company="+itemmodel.getId());
                            startActivity(in);
                        }else {
