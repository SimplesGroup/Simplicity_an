 ...
 */
public class Weddingdairiesdetail extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLPRODUCTLIST="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_diaries&id=";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.explore_wedding_dairies_detail);
