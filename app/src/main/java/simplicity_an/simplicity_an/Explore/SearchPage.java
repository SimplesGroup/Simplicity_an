...
/**
 * Created by kuppusamy on 3/27/2017.
 */
public class SearchPage extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLPRODUCTLIST="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=products&q=";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        URL=URLPRODUCTLIST+search_value;
        ...
        explore_title_textview.setText("Search "+search_value);
...
//                final Exploreitem.PriceData item=listdata.get(position);
               /* if (colorcodes.equalsIgnoreCase("004")) {
                ...
                dataAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.view_spinner_item,pricenos);
                        ...
                        if (position == 0) {
                            ...
                            for(int k=0;k<itemmodel.getPhoneList().size();k++){
                                ...
                                if(k==position) {
                                    ...
                                    userViewHolder.product_price.setText(String.valueOf(name));
