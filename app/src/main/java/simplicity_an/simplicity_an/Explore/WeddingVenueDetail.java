...
/**
 * Created by kuppusamy on 3/7/2017.
 */
public class WeddingVenueDetail extends AppCompatActivity {
    ...
    int requestcount=1;
    String URLPRODUCTLIST="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=venues&id=";
    ...
    TextView hallfeatures_textview,hallfeature_data_textview;
    TextView pricinginclude_textview,pricinginclude_data_textview;
    TextView pricingexclude_textview,pricingexclude_data_textview;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.explore_wedding_venue_detail);
       ...
       venuelocation=(TextView)findViewById(R.id.explore_weddingvenuedetail_venuelocation) ;
        ...
        hallfeatures_textview=(TextView) findViewById(R.id.explore_weddingvenuedetail_hallfeatures);
        hallfeature_data_textview=(TextView) findViewById(R.id.explore_weddingvenuedetail_hallfeatures_data);
        pricinginclude_textview=(TextView) findViewById(R.id.explore_weddingvenuedetail_including) ;
        pricinginclude_data_textview=(TextView) findViewById(R.id.explore_weddingvenuedetail_including_data);


        pricingexclude_textview=(TextView) findViewById(R.id.explore_weddingvenuedetail_priceexclude);
        pricingexclude_data_textview=(TextView) findViewById(R.id.explore_weddingvenuedetail_priceexclude_data);
...
checkandavailability_button=(Button)findViewById(R.id.explore_venue_checkavailability) ;
     ...
     checkandavailability_button.setTypeface(tf);
        ...
        hallfeatures_textview.setTypeface(tf);
        hallfeature_data_textview.setTypeface(tf);
       pricingexclude_textview.setTypeface(tf);
        pricingexclude_data_textview.setTypeface(tf);
        pricinginclude_textview.setTypeface(tf);
        pricinginclude_data_textview.setTypeface(tf);
    ...
    private void parseJsonFeed(JSONObject response){
        ...
        try {
            ...
            for(int i=0;i<productlist.length();i++){
                ...
                items.setHallfeatures(jsonObject.getString("hall_features"));
                items.setPriceinclude(jsonObject.getString("price_include"));
                items.setPriceexclude(jsonObject.getString("price_exclude"));
...
venuename.setText(jsonObject.getString("title"));
              ...
              hallfeatures_textview.setText("Hall Features");
                hallfeature_data_textview.setText(jsonObject.getString("hall_features"));
                pricinginclude_textview.setText("Mandapam Pricing Include");
                pricinginclude_data_textview.setText(Html.fromHtml(jsonObject.getString("price_include")));
                pricingexclude_textview.setText("Mandapam Pricing Exclude");
                pricingexclude_data_textview.setText(Html.fromHtml(jsonObject.getString("price_exclude")));
