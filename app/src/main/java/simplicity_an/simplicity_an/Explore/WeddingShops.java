 ...
 */
public class WeddingShops extends AppCompatActivity {
    ...
    int requestcount=1;
    String URL="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_shops";
    String URLALL;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof UserViewHolder){
                ...
                userViewHolder.explore_item_layout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent venue=new Intent(getApplicationContext(),WeddingShopslIst.class);
