...
/**
 * Created by kuppusamy on 3/4/2017.
 */
public class WeddingCategory extends AppCompatActivity {
    ...
    int requestcount=1;
    String URL="http://simpli-city.in/explore_request.php?key=smp_explore&rtype=wedding_category";
    String URLALL;
...
explore_title_textview.setText(title);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent city_page = new Intent(getApplicationContext(), MainActivityVersiontwo.class);
        ...
        if (searchPlate!=null) {
            ...
            if (searchText!=null) {
              ...
              searchText.setPadding(100, 0, 0, 0);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if(holder instanceof UserViewHolder){
                ...
                userViewHolder.explore_item_layout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
if(itemmodel.getProductname().equalsIgnoreCase("Venue")||itemmodel.getId().equalsIgnoreCase("1")){
    Intent venue=new Intent(getApplicationContext(),MarriageDecorater.class);
    venue.putExtra("TITLE",itemmodel.getProductname());
    venue.putExtra("ID",itemmodel.getId());
    startActivity(venue);
}else if(itemmodel.getProductname().equalsIgnoreCase("Wedding Diraries")||itemmodel.getId().equalsIgnoreCase("4")){
    Intent venue=new Intent(getApplicationContext(),MarriageDecorater.class);
    venue.putExtra("TITLE",itemmodel.getProductname());
    venue.putExtra("ID",itemmodel.getId());
    startActivity(venue);
}else if (itemmodel.getProductname().equalsIgnoreCase("Services")||itemmodel.getId().equalsIgnoreCase("2")){
    Intent venue=new Intent(getApplicationContext(),WeddingServices.class);
    venue.putExtra("TITLE",itemmodel.getProductname());
    venue.putExtra("ID",itemmodel.getId());
    startActivity(venue);
}else if (itemmodel.getProductname().equalsIgnoreCase("Shops")||itemmodel.getId().equalsIgnoreCase("3")){
    Intent venue=new Intent(getApplicationContext(),WeddingShops.class);
    venue.putExtra("TITLE",itemmodel.getProductname());
    venue.putExtra("ID",itemmodel.getId());
    startActivity(venue);
}
