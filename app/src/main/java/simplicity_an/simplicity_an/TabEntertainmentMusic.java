 ...
 */
public class TabEntertainmentMusic extends Fragment {
    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=ent_alldata&key=simples&qtype=music";
                        ...
                        switch (view.getId()) {
                            case R.id.listlayout_taball:
                               ...
                               /* try {
                                    ...
                                    url= url.replace("\\", "");
                                  userViewHolder.  mediaPlayer.setDataSource(itemmodel.getPlayurl());
                                    userViewHolder.        mediaPlayer.prepare(); // might take long! (for buffering, etc)
                                ...
                                if (!  userViewHolder.    mediaPlayer.isPlaying()) {
                                    userViewHolder.  mediaPlayer.start();
                                    userViewHolder.play.setImageResource(R.drawable.pause);
                                } else {
                                    if( userViewHolder. mediaPlayer.isPlaying()){
                                        userViewHolder.   mediaPlayer.pause();
                                        userViewHolder.play.setImageResource(R.drawable.play);
                                    } else {
                                        userViewHolder.   mediaPlayer.reset();
                                        userViewHolder.play.setImageResource(R.drawable.play);
                                    }
...
*/
                            ...
                            case R.id.taball_likes:
                                if(myprofileid!=null) {
                                    ...
                                    editor.putString(Activity, "entertainmentversion");
