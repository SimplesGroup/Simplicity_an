 ...
 */
public class TabEntertainmentMusic extends Fragment implements ChangeFont{
    RecyclerView recyclerview_tab_all;
    String URL="\thttp://simpli-city.in/request2.php?rtype=ent_alldatatest&key=simples&qtype=music";
...
private static     Recyclerviewtaballadapter recyclerview_tab_all_adapter;
 private static    List<ItemModel> modelListsmusic=new ArrayList<ItemModel>();
    private boolean isFragmentLoaded=false;
    MediaPlayer mediaPlayer;
    public static final String Activity = "activity";
    public static final String CONTENTID = "contentid";
    int post_likes_count=0,save_item_count;
    FloatingActionButton fabentertainmentmusic,fabplus;
 ...
 SwipeRefreshLayout swipeRefresh;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fabentertainmentmusic=(FloatingActionButton)view.findViewById(R.id.fabButton) ;
        ...
        fabentertainmentmusic.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabentertainmentmusic.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
...
//mediaPlayer=new MediaPlayer();
        ...
        //getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsmusic, recyclerview_tab_all);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsmusic.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                  ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsmusic);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    fabentertainmentmusic.setVisibility(View.VISIBLE);
                                }else {
                                    fabentertainmentmusic.setVisibility(View.GONE);
                                }
                                if (!loading
...
*/
    ...
    /* private  void CallSong(String urls){
         try {
             Log.e("LINKS",urls);
