 ...
 */
public class Tabjobs extends Fragment implements ChangeFont {

    RecyclerView recyclerview_tab_all;
    String URL="http://simpli-city.in/request2.php?rtype=alldatatest&key=simples&qtype=job";
...
FloatingActionButton fabjobs,fabplus;
    ...
    private static List<ItemModel> modelListsjob=new ArrayList<ItemModel>();
...
OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(colorcodes.length()==0){
            ...
            if(colorcodes.equalsIgnoreCase("004")){
                ...
                if(colorcodes.equalsIgnoreCase("#383838")){
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme1button));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme2));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme3));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme4));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme5));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme6));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme7));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme8));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme9));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme10));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme11));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme12));
                    ...
                    fabjobs.setBackgroundTintList(getResources().getColorStateList(R.color.theme13));
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                 swipeRefresh.setRefreshing(true);                 modelListsjob.clear();                 recyclerview_tab_all_adapter.notifyDataSetChanged();                  requestCount=0;                 getData();                                 ( new Handler()).postDelayed(new Runnable() {                     @Override                     public void run() {                         swipeRefresh.setRefreshing(false);                     }                 }, 3000);

            }
        });

       // getData();
        recyclerview_tab_all_adapter = new Recyclerviewtaballadapter(modelListsjob,recyclerview_tab_all);
    ...
    @Override
    public void change() {
        recyclerview_tab_all_adapter.Font(modelListsjob);
    }
                        ...
                        .addOnScrollListener(new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView,
                                ...
                                if(lastVisibleItem>=10){
                                    ...
                                    fabjobs.setVisibility(View.GONE);
                                }
                                if (!loading
