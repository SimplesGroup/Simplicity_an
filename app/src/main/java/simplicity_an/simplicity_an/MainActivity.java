...
*/
		...
		article.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try {
					Intent article = new Intent(MainActivity.this,Articleoftheday.class);
		...
		jobs.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent jobs = new Intent(MainActivity.this,JobsActivity.class);
				startActivity(jobs);
				finish();
			}
		});
		farming_agriculture.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent agriculture= new Intent(MainActivity.this,FarmingAgricultureActivity.class);
		...
		news.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent agriculture= new Intent(MainActivity.this,NewsActivity.class);
				startActivity(agriculture);
				finish();
			}
		});
		healthiliving.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent healthy= new Intent(MainActivity.this,HealthAndLiving.class);
		...
		govt_notifications.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent notifications= new Intent(MainActivity.this,GovernmentNotifications.class);
		...
		education.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent doit= new Intent(MainActivity.this,Education.class);
				startActivity(doit);
				finish();
			}
		});
		scienceandtech.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent scienceandtech= new Intent(MainActivity.this,ScienceandTechnology.class);
		...
		directories.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent directoriesservices= new Intent(MainActivity.this,Directories.class);
		...
		theatre.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent theatre= new Intent(MainActivity.this,Theatre.class);
		...
		travels.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent travels= new Intent(MainActivity.this,TravelsActivity.class);
		...
		photostories.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent photostories= new Intent(MainActivity.this,PhotoStories.class);
