 ...
 */
public class MainActivityVersiontwo extends AppCompatActivity implements Tab_All.OnFragmentInteractionListener,TabRadio.OnFragmentInteractionListener, simplicity_an.simplicity_an.TabMusic.OnFragmentInteractionListener,TabLayout.OnTabSelectedListener {
   ...
   private ImageButton play_music,fastforward,backforward,close_player;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainactivityversiontwo);
        ...
        /*play_music.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mediaPlayer.isPlaying()){
                    play_music.setImageResource(R.mipmap.play);
                    mediaPlayer.pause();
                }else {
                    play_music.setImageResource(R.mipmap.pause);
                    mediaPlayer.start();
                }
            }
        });*/
      ...
      StringRequest weather=new StringRequest(Request.Method.GET, WEATHER_URL, new Response.Listener<String>() {
       ...
       // title_coimbatore.setTypeface(tf);
        ...
        if(dayOfTheWeek.equalsIgnoreCase("Sun")){
            date_text.setText(Html.fromHtml("Sunday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }else if(dayOfTheWeek.equalsIgnoreCase("Mon")){
            date_text.setText(Html.fromHtml("Monday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }else if(dayOfTheWeek.equalsIgnoreCase("Tue")){
            date_text.setText(Html.fromHtml("Tuesday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }else if (dayOfTheWeek.equalsIgnoreCase("Wed")){
            date_text.setText(Html.fromHtml("Wednesday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }else if(dayOfTheWeek.equalsIgnoreCase("Thu")){
            date_text.setText(Html.fromHtml("Thursday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }else if(dayOfTheWeek.equalsIgnoreCase("Fri")){
            date_text.setText(Html.fromHtml("Friday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }else if(dayOfTheWeek.equalsIgnoreCase("Sat")){
            date_text.setText(Html.fromHtml("Saturday"+","+"&nbsp;"+sMonthNamefull+"&nbsp;"));
        }
...
*/
        ...
        language_title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent tamil=new Intent(MainActivityVersiontwo.this,MainPageTamil.class);
                startActivity(tamil);
...
/*explore.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        Intent entairnment=new Intent(MainActivityVersiontwo.this,EntertainmentVersiontwo.class);
        ...
        beyond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent beyond=new Intent(MainActivityVersiontwo.this,EventsVersionTwo.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent old_main=new Intent(MainActivityVersiontwo.this,MainActivity.class);
        ...
        notifications.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                *//*if(myprofileid!=null) {
                ...
                Intent notification_page = new Intent(MainActivityVersiontwo.this, MainPageEnglish.class);
                startActivity(notification_page);
                overridePendingTransition(R.anim.slide_right, R.anim.slide_right);
...
String count,specialdaytitle,image_special;
    ...
    private void setupViewPager(ViewPager mPager) {
        ...
        adapter.addFragment(new Tab_All(), "All");
    adapter.addFragment(new Tabnews(), "News");
        adapter.addFragment(new TabRadio(), "Radio");
      //adapter.addFragment(new Tabevent(), "Events");
        adapter.addFragment(new Tabphotostories(), "Photo Stories");
        adapter.addFragment(new Tabgovt(), "Govt.Notification");
        adapter.addFragment(new Tabjobs(), "Jobs");

        adapter.addFragment(new simplicity_an.simplicity_an.TabMusic(), "Music");
        adapter.addFragment(new TabMovies(), "Movies");
        ...
        adapter.addFragment(new simplicity_an.simplicity_an.TabHealth(), "Health");
        adapter.addFragment(new TabFood(), "Food Recipe");
