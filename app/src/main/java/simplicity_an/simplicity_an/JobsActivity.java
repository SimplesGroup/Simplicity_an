...
nameslabel_coimbatore.setTypeface(tf);
        ...
        searchbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent search_intent = new Intent(getApplicationContext(), JobsSearchview.class);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent menu_Intent = new Intent(getApplicationContext(), MainPageEnglish.class);
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(value==0){
                    Intent notification_page=new Intent(JobsActivity.this, MainPageEnglish.class);
       ...
       jobs_search=(SearchView)findViewById(R.id.searchjobs_list);
        ...
        jobs_search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Intent simplicity=new Intent(getApplicationContext(),JobsSearchview.class);
            ...
            if(holders instanceof UserViewHolderimage){
                ...
                if(itemmodel.getTypeid()==4){
                    if (mImageLoader == null)
                        mImageLoader = CustomVolleyRequest.getInstance(JobsActivity.this).getImageLoader();
